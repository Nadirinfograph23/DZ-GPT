...
export function isDarijaText(text) {
  ...
  return darijaCount >= 1 || /واشراك|كيفاش|بزاف|مليح|خايب|نتا|راني|راه|درك|دروك|ضرك|يلا|ماشي|برك|بصح|علاه|علاش|واش|وين|فين|شكون|لاباس|تاني|ياسر|قاع|فالو|خلاص|والله|مليح|مخربق|زعفان|مهبول|يخمم|يعيى|يسقسي|ديجا|واه|هيه|ياك|باه|ممبعد|معليش|ربي يسهل|واش كاين|واش صاري|فوقاش|كلش مليح|هادي سهلة|راك غالط/.test(text)
}
 ...
 */
const _FALLBACK_MAP = {
  greeting:  ['واش راك؟ 😊 أنا DZ Agent — مساعدك الذكي الجزائري! شنو تحتاج اليوم؟',
               'صباح الخير! أنا DZ Agent جاهز نعاونك. واش عندك؟',
  ...
  question:  ['سؤال زين! 🤔 خلّيني نفكّر فيه... جرّب تعاود السؤال بشويا من التفصيل باش نجاوبك أحسن.'],
  code_help: ['كود؟ 💻 ممتاز! اكتبلي تفاصيل أكثر عن المشكلة — راني نساعدك.'],
  build_web_app: ['موقع ويب؟ 🌐 ممتاز! قولّي نوع الموقع اللي تبغيه وراني نبنيهولك.'],
  default:   ['أنا DZ Agent — مساعدك الذكي الجزائري 🇩🇿\n\nنقدر نعاونك في:\n• 💬 أسئلة بالدارجة والعربية والفرنسية\n• 💻 برمجة وكود\n• 📰 أخبار الجزائر\n• ⚽ رياضة ونتائج\n• 💱 أسعار الصرف\n• 🌤️ الطقس\n\nواش تحتاج؟ 💪'],
}
