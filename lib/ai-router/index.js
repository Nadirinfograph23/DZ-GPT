...
const CAPABILITY_ORDER = {
  ...
  multilingual: ['gemini', 'huggingface', 'openai', 'groq', 'mistral', 'cohere', 'sambanova', 'nvidia', 'openrouter', 'cerebras'],
  // Code, technical, structured output — groq-coder (qwen-2.5-coder-32b) first, FREE
  technical:    ['groq-coder', 'groq', 'nvidia', 'gemini', 'openai', 'mistral', 'cohere', 'huggingface', 'cerebras', 'openrouter', 'sambanova'],
  // Retrieval, RAG, document-grounded Q&A
  retrieval:    ['cohere', 'openai', 'groq', 'gemini', 'mistral', 'nvidia', 'huggingface', 'openrouter', 'cerebras', 'sambanova'],
  // Deep reasoning — groq-reasoning (deepseek-r1-distill-llama-70b) first, FREE
  reasoning:    ['groq-reasoning', 'groq', 'openai', 'openrouter', 'gemini', 'huggingface', 'nvidia', 'cohere', 'mistral', 'cerebras', 'sambanova'],
  // Lightweight translation / chitchat
  translation:  ['groq', 'cerebras', 'mistral', 'gemini', 'huggingface', 'openai', 'cohere', 'sambanova', 'nvidia', 'openrouter'],
  // Default sequential order — Groq first (fastest), then extended fallback chain
  general:      ['groq', 'openai', 'gemini', 'mistral', 'huggingface', 'cerebras', 'nvidia', 'cohere', 'sambanova', 'openrouter'],
  // Code-specific chain — used by code/website/html taskHints
  code:         ['groq-coder', 'groq', 'nvidia', 'gemini', 'openai', 'huggingface', 'openrouter', 'cohere', 'mistral', 'cerebras'],
}
