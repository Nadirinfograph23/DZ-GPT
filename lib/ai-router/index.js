...
const CAPABILITY_ORDER = {
  ...
  realtime:     ['cerebras', 'groq', 'dahl', 'openai', 'mistral', 'gemini', 'nvidia', 'cohere', 'huggingface', 'sambanova', 'openrouter-free', 'openrouter'],
  // Multilingual, Darija, Arabic/French
  multilingual: ['cerebras', 'groq', 'gemini', 'dahl', 'huggingface', 'openai', 'mistral', 'cohere', 'sambanova', 'nvidia', 'openrouter-free', 'openrouter'],
  // Code, technical — groq-coder first (free)
  technical:    ['groq-coder', 'groq', 'cerebras', 'nvidia', 'dahl', 'gemini', 'openai', 'mistral', 'cohere', 'huggingface', 'openrouter-free', 'openrouter', 'sambanova'],
  // Retrieval, RAG, document-grounded Q&A
  retrieval:    ['cohere', 'cerebras', 'groq', 'dahl', 'openai', 'gemini', 'mistral', 'nvidia', 'huggingface', 'openrouter-free', 'openrouter', 'sambanova'],
  // Deep reasoning — groq-reasoning first (free deepseek-r1)
  reasoning:    ['groq-reasoning', 'groq', 'cerebras', 'dahl', 'openai', 'openrouter-free', 'openrouter', 'gemini', 'huggingface', 'nvidia', 'cohere', 'mistral', 'sambanova'],
  // Translation / chitchat
  translation:  ['cerebras', 'groq', 'dahl', 'mistral', 'gemini', 'huggingface', 'openai', 'cohere', 'sambanova', 'nvidia', 'openrouter-free', 'openrouter'],
  // Default — Cerebras أولاً (أسرع)، Groq ثانياً، Dahl ثالثاً كـ fallback ذكي
  general:      ['cerebras', 'groq', 'dahl', 'openai', 'gemini', 'mistral', 'huggingface', 'nvidia', 'cohere', 'sambanova', 'openrouter-free', 'openrouter'],
  // Code-specific
  code:         ['groq-coder', 'groq', 'cerebras', 'nvidia', 'dahl', 'gemini', 'openai', 'huggingface', 'openrouter-free', 'openrouter', 'cohere', 'mistral'],
  // Agent mode: Gemini أولاً (1M context window)
  agent:        ['gemini', 'cerebras', 'groq', 'dahl', 'openai', 'nvidia', 'mistral', 'cohere', 'huggingface', 'openrouter-free', 'openrouter', 'sambanova'],
  // Long context: Gemini 2.5-flash (1M) + Groq (128k) للمشاريع الكبيرة
  longcontext:  ['gemini', 'groq', 'cerebras', 'dahl', 'openai', 'nvidia', 'mistral', 'cohere', 'huggingface', 'openrouter-free', 'openrouter', 'sambanova'],
}
