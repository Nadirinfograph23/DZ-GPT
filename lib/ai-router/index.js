...
const CAPABILITY_ORDER = {
  ...
  realtime:     ['cerebras', 'groq', 'openai', 'mistral', 'gemini', 'nvidia', 'cohere', 'huggingface', 'sambanova', 'openrouter-free', 'openrouter'],
  // Multilingual, Darija, Arabic/French — Cerebras أولاً لسرعته
  multilingual: ['cerebras', 'groq', 'gemini', 'huggingface', 'openai', 'mistral', 'cohere', 'sambanova', 'nvidia', 'openrouter-free', 'openrouter'],
  // Code, technical — groq-coder first (free)
  technical:    ['groq-coder', 'groq', 'cerebras', 'nvidia', 'gemini', 'openai', 'mistral', 'cohere', 'huggingface', 'openrouter-free', 'openrouter', 'sambanova'],
  // Retrieval, RAG, document-grounded Q&A
  retrieval:    ['cohere', 'cerebras', 'groq', 'openai', 'gemini', 'mistral', 'nvidia', 'huggingface', 'openrouter-free', 'openrouter', 'sambanova'],
  // Deep reasoning — groq-reasoning first (free deepseek-r1)
  reasoning:    ['groq-reasoning', 'groq', 'cerebras', 'openai', 'openrouter-free', 'openrouter', 'gemini', 'huggingface', 'nvidia', 'cohere', 'mistral', 'sambanova'],
  // Translation / chitchat
  translation:  ['cerebras', 'groq', 'mistral', 'gemini', 'huggingface', 'openai', 'cohere', 'sambanova', 'nvidia', 'openrouter-free', 'openrouter'],
  // Default — Cerebras أولاً (أسرع)، Groq ثانياً، openrouter-free مجاني قبل المدفوع
  general:      ['cerebras', 'groq', 'openai', 'gemini', 'mistral', 'huggingface', 'nvidia', 'cohere', 'sambanova', 'openrouter-free', 'openrouter'],
  // Code-specific
  code:         ['groq-coder', 'groq', 'cerebras', 'nvidia', 'gemini', 'openai', 'huggingface', 'openrouter-free', 'openrouter', 'cohere', 'mistral'],
  // Agent mode: Gemini أولاً (1M context window) ← مُحسَّن للوكيل
  agent:        ['gemini', 'cerebras', 'groq', 'openai', 'nvidia', 'mistral', 'cohere', 'huggingface', 'openrouter-free', 'openrouter', 'sambanova'],
  // Long context: Gemini 2.5-flash (1M) + Groq (128k) للمشاريع الكبيرة
  longcontext:  ['gemini', 'groq', 'cerebras', 'openai', 'nvidia', 'mistral', 'cohere', 'huggingface', 'openrouter-free', 'openrouter', 'sambanova'],
}
...
export async function callAIRouter(messages, { max_tokens = 2000, requestId, taskHint = 'general', cerebrasKey = null } = {}) {
  ...
  const _providerFNS_runtime = { ...PROVIDER_FNS, cerebras: _cerebrasRuntimeFn }
