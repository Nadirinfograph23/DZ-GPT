...
const CAPABILITY_ORDER = {
  ...
  realtime:     ['cerebras', 'groq', 'openai', 'mistral', 'gemini', 'nvidia', 'cohere', 'huggingface', 'sambanova', 'openrouter'],
  // Multilingual, Darija, Arabic/French — Cerebras أولاً لسرعته
  multilingual: ['cerebras', 'groq', 'gemini', 'huggingface', 'openai', 'mistral', 'cohere', 'sambanova', 'nvidia', 'openrouter'],
  // Code, technical — groq-coder first (free)
  technical:    ['groq-coder', 'groq', 'cerebras', 'nvidia', 'gemini', 'openai', 'mistral', 'cohere', 'huggingface', 'openrouter', 'sambanova'],
  // Retrieval, RAG, document-grounded Q&A
  retrieval:    ['cohere', 'cerebras', 'groq', 'openai', 'gemini', 'mistral', 'nvidia', 'huggingface', 'openrouter', 'sambanova'],
  // Deep reasoning — groq-reasoning first (free deepseek-r1)
  reasoning:    ['groq-reasoning', 'groq', 'cerebras', 'openai', 'openrouter', 'gemini', 'huggingface', 'nvidia', 'cohere', 'mistral', 'sambanova'],
  // Translation / chitchat
  translation:  ['cerebras', 'groq', 'mistral', 'gemini', 'huggingface', 'openai', 'cohere', 'sambanova', 'nvidia', 'openrouter'],
  // Default — Cerebras أولاً (أسرع)، Groq ثانياً
  general:      ['cerebras', 'groq', 'openai', 'gemini', 'mistral', 'huggingface', 'nvidia', 'cohere', 'sambanova', 'openrouter'],
  // Code-specific
  code:         ['groq-coder', 'groq', 'cerebras', 'nvidia', 'gemini', 'openai', 'huggingface', 'openrouter', 'cohere', 'mistral'],
}
