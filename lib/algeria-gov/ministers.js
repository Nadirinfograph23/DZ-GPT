...
export const ALGERIA_PRIME_MINISTERS = [
  {
    ...
    since: 'نوفمبر 2023',
    note: 'الوزير الأول الحالي. خلف أيمن بن عبد الرحمن.',
    source: 'static',
  },
  {
    role: 'وزير أول (سابق)',
...
// ─── أعضاء حكومة العرباوي (نوفمبر 2023 – الآن) ──────────────────────────────
export const KNOWN_CURRENT_MINISTERS = [
  ...
  { role: 'وزير العدل حافظ الأختام', name: 'عمر بلحاج', ministry: 'العدل', since: '2023', source: 'static' },
  ...
  { role: 'وزير الصناعة', name: 'علي عون', ministry: 'الصناعة', since: '2021', source: 'static' },
  { role: 'وزير الاقتصاد المعرفي والمؤسسات الناشئة والمؤسسات الصغيرة', name: 'ياسين وليد', ministry: 'الاقتصاد المعرفي', since: '2023', source: 'static' },
  { role: 'وزير التجارة وترقية الصادرات', name: 'الطيب ضيف', ministry: 'التجارة', since: '2023', source: 'static' },
  { role: 'وزير الفلاحة والتنمية الريفية', name: 'يوسف شرفة', ministry: 'الفلاحة', since: '2023', source: 'static' },
  ...
  { role: 'وزير النقل', name: 'صالح أمار', ministry: 'النقل', since: '2023', source: 'static' },
  // القطاع الاجتماعي
  ...
  { role: 'وزير التكوين والتعليم المهنيين', name: 'يحيى بوبكر', ministry: 'التكوين المهني', since: '2023', source: 'static' },
  ...
  // الثقافة والاتصال
  { role: 'وزير الثقافة والفنون', name: 'زينب بن دودة', ministry: 'الثقافة', since: '2020', source: 'static' },
  { role: 'وزير الاتصال', name: 'محمد لعقاب', ministry: 'الاتصال', since: '2020', source: 'static' },
  // البيئة والدين
...
export function buildMinistersContext(data) {
  ...
  const presidents = (data.ministers || KNOWN_STATIC).filter(m =>
    m.role.includes('رئيس الجمهورية') || m.role.includes('رئيس دولة') || m.role.includes('رئيس مجلس الثورة')
  )
  const primes = (data.ministers || KNOWN_STATIC).filter(m => m.role.includes('وزير أول'))
  const ministers = (data.ministers || KNOWN_STATIC).filter(m =>
  ...
  const lines = [
    ...
    `> ⚠️ استخدم هذه البيانات للإجابة عن الوزراء والمناصب الحكومية — لا تخترع منصباً.`,
    '',
    `### رئاسة الجمهورية`,
    '| المنصب | الاسم | الفترة |',
    '|--------|-------|--------|',
  ...
  if (ministers.length > 0) {
    lines.push('', `### أعضاء الحكومة الحالية (حكومة العرباوي)`)
