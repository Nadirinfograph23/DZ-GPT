...
// OR loads a remote URL — and a GitHub Actions workflow that builds APK + GitHub Release
...
export function detectAndroidBuildQuery(msg) {
  ...
  // أنماط "تحويل موقع → تطبيق" — أي جملة تجمع فعل التحويل مع موقع/رابط وتطبيق
  const CONVERT_PATTERNS = [
    ...
    // إذا يوجد URL + كلمة تطبيق في نفس الرسالة
