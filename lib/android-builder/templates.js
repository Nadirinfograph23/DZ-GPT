...
export const TYPE_KEYWORDS = {
  ...
  kotlin: [
    ...
    'تطبيق محلي', 'native app',
  ],
}

// ── المستودعات المرجعية على GitHub ───────────────────────────────────────
export const GITHUB_TEMPLATES = {
  ...
  capacitor: {
    ...
    description_ar: 'يحوّل أي موقع HTML/CSS/JS إلى تطبيق أندرويد أصلي مع الوصول لميزات الهاتف',
  },
  reactnative: {
    label: 'React Native',
