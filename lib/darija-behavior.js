...
export const SOCIAL_EXPRESSIONS = {
  ...
  'وش الدعوة':       { meaning: 'كيف الحال (لهجة غرب)',           response: 'الدعوة هانية — والبط يعوم 🪿 كيفاش نعاونك؟',   category: 'casual_shift', isTopicShift: true },
  'واش الدعوا':      { meaning: 'كيف الحال (لهجة قسنطينة)',       response: 'الدعوة هانية والبط يعوم 🪿 — واش عندك؟',        category: 'casual_shift', isTopicShift: true },
  'الدعوة':          { meaning: 'كيف الأمور — في سياق الدردشة',   response: 'الدعوة هانية 😊 — والبط يعوم 🪿 واش عندك؟',     category: 'casual_shift', isTopicShift: true },
  ...
  'واش الحكاية':     { meaning: 'ما القصة / كيف الحال',           response: 'الحكاية بصح وبلاش 😄 — واش عندك؟',              category: 'casual_shift', isTopicShift: true },
  'وش الحكاية':      { meaning: 'ما القصة',                       response: 'الحكاية هانية، قولي شنو عندك 🙂',               category: 'casual_shift', isTopicShift: true },
  'واش قصتك':        { meaning: 'ما أخبارك؟',                     response: 'قصتي مليحة الحمد لله 😄 — وأنت؟',              category: 'casual_shift', isTopicShift: true },
  ...
  'كاش خبر':         { meaning: 'أي خبر؟ / ما الجديد؟',          response: 'خبر خير إن شاء الله — قولي واش عندك 😊',        category: 'casual_shift', isTopicShift: true },
  ...
  // ─── تعابير يومية جزائرية شعبية ───────────────────────────────────────────
  'راك زعفان':       { meaning: 'هل أنت غاضب؟',                  response: 'والله راني كيما كيما 😄 — مليح وأنت؟',           category: 'casual_shift', isTopicShift: true },
  'راني زعفان':      { meaning: 'أنا غاضب',                      response: 'وا كاش سبب؟ قولّي 😊',                          category: 'emotional' },
  'راني ضايع':       { meaning: 'أنا تائه / في ورطة',            response: 'قولّي وين الضياع ونخرجوك منو معاً 😄',           category: 'casual_shift', isTopicShift: true },
  'هاني':            { meaning: 'ها أنا / تفضّل',                response: 'واه خويا — قولّي واش عندك 😊',                  category: 'casual_shift', isTopicShift: true },
  'ها أنا':          { meaning: 'أنا هنا — جاهز',                response: 'وأنا راني هنا كذلك — قولّي 🤖',                  category: 'casual_shift', isTopicShift: true },
  'هانا':            { meaning: 'ها نحن',                        response: 'هانا — واش نبدأوا؟ 🚀',                         category: 'casual_shift', isTopicShift: true },
  'يلا':             { meaning: 'هيا / انطلق',                   response: 'يلا — قولّي واش تحب 💪',                         category: 'casual_shift', isTopicShift: true },
  'طيب':             { meaning: 'حسناً / طيب',                   response: 'طيب — واش عندك؟ 🙂',                            category: 'casual_shift', isTopicShift: true },
  'خلاص':            { meaning: 'انتهى / حسناً',                 response: 'خلاص مليح — واش كاين أخرى؟ 🙂',                 category: 'casual_shift', isTopicShift: true },
  'يزي':             { meaning: 'يكفي / بس',                     response: 'يزي؟ مليح 😊 — واش تبغي دروك؟',                  category: 'casual_shift', isTopicShift: true },
  'زيد':             { meaning: 'أكمل / واصل',                   response: 'زيد نكمل — سامعك 🙂',                           category: 'casual_shift', isTopicShift: true },
  'قول':             { meaning: 'قل / تكلّم',                    response: 'قائل — أنا سامعك 👂',                           category: 'casual_shift', isTopicShift: true },
  'حبيت نسقسيك':    { meaning: 'أريد أن أسألك',                  response: 'سقسي كيما تحب، الباب محلول 🚪',                 category: 'casual_shift', isTopicShift: true },
  'واش يبانلك':      { meaning: 'ما رأيك؟',                      response: 'يبانلي راك على صح — قولّي أكثر 😊',              category: 'casual_shift', isTopicShift: true },
  'واش تحسب':        { meaning: 'ماذا تعتقد؟',                   response: 'نحسب مليح — واش عندك على بالك؟ 🙂',              category: 'casual_shift', isTopicShift: true },
  'راني فرحان':      { meaning: 'أنا سعيد',                      response: 'هذا اللي نحبوه 🌟 — واش السبب؟',                 category: 'emotional' },
  'راني مبسوط':      { meaning: 'أنا مرتاح / سعيد',             response: 'الحمد لله — استمر هكا 😊',                       category: 'emotional' },
  'راني تعبان':      { meaning: 'أنا متعب',                      response: 'خذ راحتك خويا — وإذا تبغي نعاونك راني هنا 🤍',   category: 'emotional' },
  'راني حابس':       { meaning: 'عالق / لا أعرف',                response: 'وين راه المشكل بالضبط؟ قولّي ونشوفو 🔍',         category: 'task_context' },
  'ما ندير':         { meaning: 'لا أعرف ماذا أفعل',             response: 'قولّي المشكلة ونشوفو الحل معاً 💡',              category: 'task_context' },
  'مزيان هكا':       { meaning: 'هكذا مثالي',                    response: 'الحمد لله — يسعدني كنت مفيد 😊',                 category: 'agreement' },
  'هكا هكا':         { meaning: 'عادي عادي / كيما كيما',         response: 'عادي — نكمل شوية؟ 😄',                          category: 'casual_shift', isTopicShift: true },
  'على خاطري':       { meaning: 'من أجلي / أحسنت',               response: 'على خاطرك راني دايما هنا 🤍',                    category: 'emotional' },
  'شرفت':            { meaning: 'شرّفتنا / أهلاً بك',           response: 'شرّفتنا والله — يسعدني لقاك 😊',                 category: 'greeting' },
  'راك تعبني':       { meaning: 'أتعبتني (بمودة)',               response: 'ما نعيّبكش، راني هنا بصح 😄',                   category: 'casual_shift', isTopicShift: true },
  'راك ذكي':         { meaning: 'أنت ذكي',                       response: 'الذكاء مقسوم يا خويا 😄 — وأنت كذلك 💪',          category: 'praise' },
  'والله زوين':      { meaning: 'والله جميل / ممتاز',           response: 'الله يبارك — شكراً خويا 💚',                     category: 'praise' },
  'هاهو':            { meaning: 'ها هو / تفضل',                  response: 'هاهو اللي كاين 😄 — واش عندك؟',                  category: 'casual_shift', isTopicShift: true },
  'نورمال':          { meaning: 'طبيعي / عادي',                   response: 'نورمال خويا، هكا يكون 😊 — واش عندك؟',           category: 'casual_shift', isTopicShift: true },
  'بسيطة':           { meaning: 'بسيطة / سهلة',                  response: 'بسيطة صح — يلا نبدأوا 💪',                      category: 'agreement' },
  'سهل':             { meaning: 'سهل',                           response: 'سهل إن شاء الله — يلا 💪',                      category: 'agreement' },
  'واه صح':          { meaning: 'نعم صحيح',                      response: 'الحمد لله — واش نكمل؟ 😊',                      category: 'agreement' },
  'والله صح':        { meaning: 'والله صحيح',                    response: 'والله صح خويا 🙏 — ويسعدني',                     category: 'agreement' },
  'يا وخي':          { meaning: 'يا صديقي / يا أخي (مودة)',      response: 'واه يا وخي؟ قولّي 😄',                          category: 'casual_shift', isTopicShift: true },
  'يا وليدي':        { meaning: 'يا ابني / يا صاحبي (مودة)',    response: 'واه وليدي — قولّي واش عندك 😊',                  category: 'casual_shift', isTopicShift: true },
  'ما كاين مشكل':    { meaning: 'لا مشكلة',                      response: 'مليح — نكملو إن شاء الله 💪',                    category: 'agreement' },
  'ما كاينش مشكل':   { meaning: 'لا توجد مشكلة',                response: 'مليح — يلا نكمل 😊',                            category: 'agreement' },
  'روح الله معاك':   { meaning: 'اذهب مع السلامة',               response: 'والله يكون معاك دايما — رجع متى بغيت 🤍',        category: 'farewell' },
  'حتى مرة':         { meaning: 'في المرة القادمة',              response: 'حتى مرة خويا — وأنا هنا ديما 🤍',               category: 'farewell' },
  'نتلقاوا':         { meaning: 'نلتقي مجدداً',                  response: 'إن شاء الله نتلقاوا — دايما في الخدمة 🙂',       category: 'farewell' },
  'بالله عليك':      { meaning: 'رجاءً / أقسم بالله',           response: 'بالله نعاونك — قولّي كيفاش 😊',                  category: 'request' },
  'شويّة':           { meaning: 'قليلاً / شوية',                 response: 'شويّة شويّة نوصلو — قولّي 🙂',                    category: 'casual_shift', isTopicShift: true },
  'معليش':           { meaning: 'عذراً / لا بأس',                response: 'معليش خويا — ما فيها شيء 😊',                   category: 'casual_shift', isTopicShift: true },
  'مكانش مشكلة':     { meaning: 'لا توجد مشكلة',                response: 'مكانش — يلا نكمل 💪',                           category: 'agreement' },
  'دير النيفو':      { meaning: 'ارفع مستواي',                   response: 'النيفو عليك وأنا نعاونك توصلو 🚀',              category: 'casual_shift', isTopicShift: true },
  'زيدني':           { meaning: 'أعطني المزيد',                  response: 'نزيدك — قولّي واش تحب أكثر 💡',                  category: 'task_context' },
  'قولي بصح':        { meaning: 'قل لي الحقيقة',                 response: 'بصح وبلاش — نقولك اللي نعرفو 😊',               category: 'casual_shift', isTopicShift: true },
  ...
  'شكون خدمك':       { meaning: 'من أنشأك؟',           response: 'خدمني نذير حوامرية (Nadir Houamria) 🇩🇿 — مطور جزائري مشهور بـ Nadir Infograph. منصتي: DZ AGENT 🚀', category: 'identity' },
  'شكون طورك':       { meaning: 'من طوّرك؟',           response: 'طوّرني نذير حوامرية (Nadir Infograph) 🇩🇿 — منصة DZ AGENT المصنوعة في الجزائر 💚', category: 'identity' },
  'شكون صنعك':       { meaning: 'من صنعك؟',            response: 'صنعني نذير حوامرية — Nadir Houamria 🇩🇿 مطور جزائري، منصة DZ AGENT على dzagent.app', category: 'identity' },
  'شكون برمجك':      { meaning: 'من برمجك؟',           response: 'برمجني نذير حوامرية (Nadir Infograph) 🇩🇿 — المطور الجزائري وراء منصة DZ AGENT 🤖', category: 'identity' },
  'مؤسس dz agent':   { meaning: 'من أسّس DZ Agent؟',   response: 'مؤسس DZ AGENT هو نذير حوامرية (Nadir Houamria) 🇩🇿 — Nadir Infograph. منصة DZ AGENT على dzagent.app', category: 'identity' },
  'مؤسس dz gpt':     { meaning: 'من أسّس DZ AGENT؟',     response: 'مؤسس DZ AGENT هو نذير حوامرية (Nadir Houamria) 🇩🇿 — مطور جزائري، Nadir Infograph. الموقع: dzagent.app', category: 'identity' },
  'من خدمك':         { meaning: 'من أنشأك؟',           response: 'خدمني نذير حوامرية (Nadir Houamria) — Nadir Infograph 🇩🇿، المطور الجزائري وراء DZ AGENT 🚀', category: 'identity' },
  'من طورك':         { meaning: 'من طوّرك؟',           response: 'طوّرني نذير حوامرية — Nadir Infograph 🇩🇿، منصة DZ AGENT — dzagent.app', category: 'identity' },
  'من صنعك':         { meaning: 'من صنعك؟',            response: 'صنعني نذير حوامرية (Nadir Houamria) 🇩🇿 — مطور جزائري، Nadir Infograph، منصة DZ AGENT', category: 'identity' },
  'خدمك شكون':       { meaning: 'من أنشأك؟',           response: 'خدمني نذير حوامرية (Nadir Infograph) 🇩🇿 — المطور وراء DZ AGENT، الموقع: dzagent.app', category: 'identity' },
  'صنعك شكون':       { meaning: 'من صنعك؟',            response: 'صنعني نذير حوامرية — Nadir Houamria 🇩🇿، Nadir Infograph، منصة DZ AGENT', category: 'identity' },
...
export async function searchDarijaWordMeaning(word) {
  ...
  try {
    ...
    const r = await fetch(ddgUrl, {
      headers: { 'User-Agent': 'DZ-GPT-Agent/1.0 (+https://dzagent.app)' },
...
export function buildSocialBehaviorPrompt(socialExpr = null, unknownWords = [], webMeanings = {}) {
  ...
  if (socialExpr) {
    if (socialExpr.isTopicShift) {
      ...
      lines.push('⚡ **تعبير اجتماعي مكتشف — رد مباشر مطلوب:**')
      lines.push(`  المستخدم قال: "${socialExpr.expression}"`)
      lines.push(`  🎯 **ردّ حرفياً بـ:** "${socialExpr.response}"`)
      lines.push('  ✅ أنت جزائري تتكلم مع جزائري — رد بالدارجة مباشرة كما يفعل الناس.')
      lines.push('  🚫 لا تشرح معنى التعبير للمستخدم — هو يعرفه، لا تقل "واش راك = كيف حالك".')
      lines.push('  🚫 لا تقل "شكراً على شكرك" أو "على الرحب" أو "بكل سرور" — هذا غير جزائري.')
      lines.push('  🚫 لا تضع علامات اقتباس أو تفسيرات أو ترجمة للتعبير.')
  ...
  lines.push('')
  lines.push('  🚫 القاعدة الذهبية: لا تشرح التعبير — المستخدم يعرفه، هو يريد ردّاً لا درساً.')
  lines.push('  🚫 ممنوع: كتابة "واش راك = كيف حالك" أو أي صيغة شرح/ترجمة.')
  lines.push('  🚫 ممنوع: استخدام علامة "=" أو "يعني" أو "أي" لتفسير تعبير دارجي.')
  lines.push('  ✅ المطلوب: رد قصير طبيعي بالدارجة كما يرد جزائري على جزائري.')
  lines.push('')
  lines.push('  ردود محددة (مُلزِمة):')
  lines.push('  • "يعطيك الصحة" / "يعطيك صحة" → "بلا مزية"')
  lines.push('  • "يسلمو" / "يسلم" → "والله يسلمك"')
  lines.push('  • "بارك الله فيك" → "وفيك بارك الله"')
  lines.push('  • "مرسي" / "شكرا" / "نشكرك" → "بلا مزية" أو "ولا يهمك"')
  lines.push('  • "عيشك" → "وعيشك أنت"')
  lines.push('  • "واش راك" / "كيداير" → "لاباس الحمد لله، يسقسي عليك الخير 😊"')
  lines.push('  • "صباح النور" → "صباح الياسمين ☀️"')
  lines.push('  • "مساء النور" → "مساء الفل 🌙"')
  lines.push('  • كلمة دارجة مجهولة → اسأل: "سامحني ما فهمتش — شحال تقصد بـ [كلمة]؟"')
  lines.push('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
