...
export const SOCIAL_EXPRESSIONS = {
  ...
  'وش الدعوة':       { meaning: 'كيف الحال (لهجة غرب)',           response: 'الدعوة مزيانة — والبط يعوم 😄 كيفاش نعاونك؟',   category: 'casual_shift', isTopicShift: true },
  'الدعوة':          { meaning: 'كيف الأمور — في سياق الدردشة',   response: 'الدعوة هانية 😊 — واش عندك؟',                   category: 'casual_shift', isTopicShift: true },
  'واش الحوايج':     { meaning: 'كيف الأمور (تعبير شعبي)',        response: 'الحوايج مزيانة والحمد لله 😊 — وعندك؟',          category: 'casual_shift', isTopicShift: true },
  'واش جديد':        { meaning: 'ما الجديد؟',                    response: 'جديد مزيان — أنا راني خدّام نتعلم كل يوم 😄 وأنت؟', category: 'casual_shift', isTopicShift: true },
  ...
  'شلونك':           { meaning: 'كيف حالك (قريبة من المشرقية)',   response: 'شلوني مزيان الحمد لله 😊 — وأنت كيداير؟',        category: 'casual_shift', isTopicShift: true },
  ...
  // ─── مدح ───────────────────────────────────────────────────────────────────
  'مزيان بزاف':      { meaning: 'ممتاز جداً',          response: 'يسعدني هذا — دايما هنا نعاونك 🙏',            category: 'praise' },
...
const KNOWN_DARIJA_WORDS = new Set([
  ...
  'بزاف','ياسر','مليح','خايب','مزيان','يلا','درك','دروك','ضرك','برك','بصح',
