...
export const DZ_COMPANIES_KB = {
  ...
  'redmed': {
    ...
    nameEn: 'RedMed Group',
    aliases: [
      'red med', 'redmed', 'Red Med', 'RedMed', 'RedMed Group', 'Red Med Group',
      'ريد ميد', 'ريدميد', 'مجمع ريد ميد', 'redmed group',
    ],
    sector: '✈️ خدمات بترولية / طيران / لوجستيك / قاعدة حياة',
    sectorFr: 'Services pétroliers / Aviation / Logistique / Base vie',
    founded: '2000',
    hq: 'حاسي مسعود — BP 509 Route In Aménas 30500',
    hqFr: 'Hassi Messaoud — BP 509 Route In Aménas 30500',
    phone: '+213 29 74 94 00',
    website: 'http://www.redmed-group.com/fr/',
    description: `مجمع RedMed Group — من أبرز المجمعات الخاصة الجزائرية في قطاع الخدمات البترولية، مقرّه حاسي مسعود.

🎯 المجالات الرئيسية:
• ✈️ العمل الجوي (Travail Aérien) — رحلات هليكوبتر وخدمات جوية للقطاع البترولي
• 🏕️ RedMed Base — قواعد حياة ومكاتب وإقامات لشركات المحروقات
• 🚛 اللوجستيك — نقل ثقيل متعدد الأنماط وخدمات لوجستية متكاملة
• 🎓 التكوين — مركز تدريب وتأهيل وشهادات مهنية (ATS / ATS International)
• 🏗️ الهندسة المدنية — أشغال البنية التحتية
• 🌿 البيئة — حلول بيئية في البيئة الصحراوية
• 🏕️ المخيمات المتنقلة (Camps mobiles)

🏢 الفروع والشركات التابعة:
Star Aviation | Jet Air | SAHARA Aviation Training School | ATS International
SOS Algeria | Laboratoire Fechkeur | NewRest Remote Algérie | AFMC Services

🌍 الرؤية: "التكامل الشامل والشراكات المستدامة" — يخدم شركات النفط والغاز في الجزائر وأفريقيا.`,
    descriptionFr: `RedMed Group, groupe privé algérien de référence dans les services pétroliers, basé à Hassi Messaoud.

Activités principales :
• Travail aérien (hélicoptères et services aéronautiques pour le secteur pétrolier)
• RedMed Base : bases vie, offices et résidences pour les pétroliers
• Logistique multisectorielle et transport lourd
• Formation & certification (ATS, ATS International)
• Génie civil, Environnement, Camps mobiles

Filiales : Star Aviation, Jet Air, SAHARA Aviation Training School, ATS International, SOS Algeria, Laboratoire Fechkeur, NewRest Remote Algérie, AFMC Services.

Vision : "Intégration globale et Partenariats durables."`,
    employees: '+2,000',
  },
...
function _formatCompanyResponse(company, wikiData = null) {
  ...
  lines.push(``)
  lines.push(`> 🇩🇿 *معلومات من قاعدة بيانات DZ AGENT للشركات الجزائرية — 2026*`)
...
function _formatGeneralCompaniesResponse() {
  ...
  lines.push(`---`)
  lines.push(`> 🇩🇿 *DZ AGENT — قاعدة بيانات الشركات الجزائرية | Base de données entreprises algériennes*`)
  return lines.join('\n')
}
...
export async function lookupUnknownAlgerianCompany(companyName) {
  ...
  const lines = [
    ...
    ``,
    `> *DZ AGENT — Algerian Companies Database 2026*`,
  ]
