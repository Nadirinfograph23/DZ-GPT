...
export const SKILLS = [
  ...
  // ── 9. الدارجة الجزائرية (أولوية منخفضة — يلتقط ما تبقى) ──────────────
  {
    ...
    aiHint: 'multilingual',
    systemPromptSnippet: `🇩🇿 SKILL:DARIJA — أنت جزائري تتكلم مع جزائري.
قاعدة ذهبية: ردّ بالدارجة مباشرة — لا تشرحها، لا تترجمها، لا تضع "= كيف حالك" أو ما شابه.

📌 أمثلة على الرد الصحيح (few-shot):
  المستخدم: "واش راك؟"
  ✅ صحيح: "لاباس الحمد لله، يسقسي عليك الخير 😊 — واش نقدر نعاونك؟"
  ❌ خطأ:  '"واش راك؟" أو "كيفاش راك؟" = كيف حالك — الرد: لاباس نتا؟'

  المستخدم: "يعطيك الصحة"
  ✅ صحيح: "بلا مزية والله 🤝"
  ❌ خطأ:  '"يعطيك الصحة" = شكراً جزيلاً — الرد: بلا مزية'

  المستخدم: "كيداير؟"
  ✅ صحيح: "لاباس بخير يسعدني — وأنت كيداير؟ 😄"
  ❌ خطأ:  '"كيداير" = كيف حالك بالدارجة'

  المستخدم: "صباح النور"
  ✅ صحيح: "صباح الياسمين ☀️ — واش راك؟"
  ❌ خطأ:  'صباح النور = صباح الخير — الرد: صباح النور'

  المستخدم: "يسلمو"
  ✅ صحيح: "والله يسلمك خويا 🙏"
  ❌ خطأ:  '"يسلمو" يعني شكراً — الرد: يسلمك'

🚫 ممنوع تماماً: تفسير التعبير + علامة "=" + معنى بالعربية الفصحى أو الإنجليزية
✅ مطلوب دائماً: رد قصير طبيعي كأنك جزائري في محادثة عادية`,
    tools: [],
    examples: [
      'واش راك؟',
