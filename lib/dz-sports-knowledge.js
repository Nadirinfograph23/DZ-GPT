...
export function isWC2026SquadQuery(q = '') {
  ...
  // Must have squad/lineup keywords AND WC/team keywords
  const hasSquad = /تشكيل|قائمة|لاعبي|لاعبون|مجموعة اللاعبين|قائمة ال|أفراد المنتخب|أعضاء المنتخب|الـ26|26 لاعب/.test(t)
  const hasWC   = /كأس العالم|مونديال|2026|wc2026|wc 2026/.test(t)
