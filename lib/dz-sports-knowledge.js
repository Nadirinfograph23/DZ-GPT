...
export function buildWC2026MatchVsResponse(team1 = '', team2 = '') {
  ...
  if (fixture) {
    ...
    const hasScore   = fixture.statusType === 'finished' &&
                       fixture.homeScore != null && fixture.awayScore != null

    const statusBadge = hasScore     ? '✅ انتهت (نتيجة رسمية)'
                      : isPast       ? '✅ انتهت'
                      : isLive       ? '🔴 جارية الآن'
                      :                '🕒 لم تُلعب بعد'
    ...
    // ── إظهار النتيجة إذا كانت متوفرة ────────────────────────────────────────
    if (hasScore) {
      const winnerLine = fixture.winner
        ? `🏆 **الفائز:** ${WC2026_FLAGS[fixture.winner] || ''} ${fixture.winner}`
        : `🤝 **تعادل**`
      lines.push(
        `### 🏁 النتيجة النهائية`,
        `| ${f1} ${fixture.homeTeam} | النتيجة | ${f2} ${fixture.awayTeam} |`,
        `|---------|---------|---------|`,
      ...
      // المباراة انتهت أو جارية لكن النتيجة لم تُحدَّث محلياً بعد
      lines.push(
        isLive
          ? `> 🔴 **المباراة جارية الآن** — تابع النتيجة مباشرةً:`
          : `> ✅ **المباراة انتهت** — للنتيجة الرسمية تابع المصادر الحية:`,
        ``,
        `| المصدر | الرابط |`,
        `|--------|--------|`,
        `| 📡 **365scores** | [النتيجة الحية](https://www.365scores.com/ar/football/world-cup-2026~763) |`,
        `| ⚽ **FotMob** | [مباريات كأس العالم](https://www.fotmob.com/ar/leagues/77/matches/world-cup) |`,
        `| 🏆 **FIFA الرسمي** | [النتائج الرسمية](https://www.fifa.com/worldcup) |`,
        `| 🇩🇿 **كووورة** | [مباريات الجزائر](https://www.kooora.com/) |`,
        ``,
      )
    }
    ...
    lines.push(
      ...
      `> ${groupTeams}`,
      ``,
      `> 📡 **المصدر**: DZ-Sports-Knowledge v2.0 — بيانات FIFA كأس العالم 2026 ✅`,
    )
...
// المصدر: FAF + الجزيرة + APS — المدرب: فلاديمير بيتكوفيتش
// آخر تحديث: يونيو 2026 (القائمة النهائية الرسمية)
// ─────────────────────────────────────────────────────────────────────────────
...
export const WC2026_ALGERIA_SQUAD = {
  ...
  players: [
    // ── حراس المرمى ────────────────────────────────────────────────────────
    { num: 1,  name: 'ملفان ماستيل',        nameEn: 'Melvin Masthel',       pos: 'حارس مرمى', posEn: 'GK', club: 'بايير ليفركوزن 🇩🇪',           caps: 4,   goals: 0, age: 24 },
    { num: 16, name: 'لوكا زيدان',           nameEn: 'Luca Zidane',          pos: 'حارس مرمى', posEn: 'GK', club: 'غرناطة 🇪🇸',                   caps: 8,   goals: 0, age: 26 },
    { num: 23, name: 'أسامة بنبوت',          nameEn: 'Oussama Ben Bout',     pos: 'حارس مرمى', posEn: 'GK', club: 'اتحاد الجزائر 🇩🇿',            caps: 6,   goals: 0, age: 29 },
    // ── المدافعون ──────────────────────────────────────────────────────────
    { num: 2,  name: 'رفيق بلغالي',          nameEn: 'Rafik Belghali',       pos: 'مدافع',      posEn: 'RB', club: 'هيلاس فيرونا 🇮🇹',             caps: 22,  goals: 1, age: 28 },
    { num: 3,  name: 'رامي بن سبعيني',       nameEn: 'Ramy Bensebaini',      pos: 'مدافع',      posEn: 'LB', club: 'بوروسيا دورتموند 🇩🇪',         caps: 65,  goals: 4, age: 29 },
    { num: 4,  name: 'عيسى ماندي',           nameEn: 'Aïssa Mandi',          pos: 'مدافع',      posEn: 'CB', club: 'ليل 🇫🇷',                      caps: 70,  goals: 2, age: 34 },
    { num: 5,  name: 'سمير شرقي',            nameEn: 'Samir Cherki',         pos: 'مدافع',      posEn: 'CB', club: 'باريس FC 🇫🇷',                  caps: 18,  goals: 0, age: 27 },
    { num: 14, name: 'ريان آيت نوري',        nameEn: 'Rayan Aït Nouri',      pos: 'مدافع',      posEn: 'LB', club: 'مانشستر سيتي 🏴󠁧󠁢󠁥󠁮󠁧󠁿',           caps: 31,  goals: 1, age: 23 },
    { num: 15, name: 'محمد أمين توقاي',      nameEn: 'Mohamed Amine Tougaï', pos: 'مدافع',      posEn: 'CB', club: 'الترجي التونسي 🇹🇳',            caps: 22,  goals: 0, age: 24 },
    { num: 18, name: 'جاوان حجام',           nameEn: 'Jaouen Hadjam',        pos: 'مدافع',      posEn: 'RB', club: 'يونج بويز 🇨🇭',                caps: 14,  goals: 0, age: 23 },
    { num: 22, name: 'زين الدين بلعيد',      nameEn: 'Zinedine Belaïd',      pos: 'مدافع',      posEn: 'CB', club: 'مولودية الجزائر 🇩🇿',           caps: 12,  goals: 1, age: 26 },
    { num: 13, name: 'أشرف عبادة',           nameEn: 'Achraf Abada',         pos: 'مدافع',      posEn: 'CB', club: 'اتحاد المدية 🇩🇿',              caps: 9,   goals: 0, age: 25 },
    // ── لاعبو الوسط ────────────────────────────────────────────────────────
    { num: 6,  name: 'رميز زروقي',           nameEn: 'Ramiz Zerrouki',       pos: 'وسط',        posEn: 'CM', club: 'تفنتي 🇳🇱',                    caps: 38,  goals: 3, age: 26 },
    { num: 7,  name: 'فارس شايبي',           nameEn: 'Fares Chaïbi',         pos: 'وسط',        posEn: 'CM', club: 'آينتراخت فرانكفورت 🇩🇪',        caps: 24,  goals: 4, age: 23 },
    { num: 8,  name: 'حسام عوار',            nameEn: 'Houssem Aouar',        pos: 'وسط',        posEn: 'AM', club: 'الاتحاد 🇸🇦',                  caps: 46,  goals: 7, age: 27 },
    { num: 10, name: 'نبيل بن طالب',         nameEn: 'Nabil Bentaleb',       pos: 'وسط',        posEn: 'CM', club: 'ليل 🇫🇷',                      caps: 52,  goals: 3, age: 30 },
    { num: 17, name: 'إبراهيم مازة',         nameEn: 'Ibrahim Maza',         pos: 'وسط',        posEn: 'AM', club: 'باير ليفركوزن 🇩🇪',             caps: 16,  goals: 4, age: 20 },
    { num: 19, name: 'هشام بوداوي',          nameEn: 'Hichem Boudaoui',      pos: 'وسط',        posEn: 'CM', club: 'OGC نيس 🇫🇷',                  caps: 42,  goals: 5, age: 27 },
    { num: 21, name: 'ياسين تيتراوي',        nameEn: 'Yassine Titreauai',    pos: 'وسط',        posEn: 'CM', club: 'شارلروا 🇧🇪',                  caps: 20,  goals: 2, age: 26 },
    // ── المهاجمون ──────────────────────────────────────────────────────────
    { num: 9,  name: 'رياض محرز',            nameEn: 'Riyad Mahrez',         pos: 'مهاجم',      posEn: 'RW', club: 'الأهلي السعودي 🇸🇦',           caps: 92,  goals: 30, age: 35 },
    { num: 11, name: 'أنيس حاج موسى',        nameEn: 'Anis Hadjam Moussa',   pos: 'مهاجم',      posEn: 'LW', club: 'فيينورد 🇳🇱',                  caps: 18,  goals: 5, age: 22 },
    { num: 20, name: 'محمد أمين عمورة',      nameEn: 'Mohamed Amine Amoura', pos: 'مهاجم',      posEn: 'FW', club: 'ولفسبورغ 🇩🇪',                 caps: 26,  goals: 8, age: 24 },
    { num: 24, name: 'نضير بن بولعيد',       nameEn: 'Nadir Benbouali',      pos: 'مهاجم',      posEn: 'FW', club: 'خيرونا 🇪🇸',                   caps: 14,  goals: 4, age: 25 },
    { num: 25, name: 'عادل بولبينة',         nameEn: 'Adel Boulebina',       pos: 'مهاجم',      posEn: 'FW', club: 'الدحيل 🇶🇦',                   caps: 11,  goals: 3, age: 25 },
    { num: 26, name: 'أمين قويري',           nameEn: 'Amine Gouiri',         pos: 'مهاجم',      posEn: 'ST', club: 'مرسيليا 🇫🇷',                  caps: 38,  goals: 11, age: 24 },
    { num: 12, name: 'فارس قجمس',            nameEn: 'Fares Ghedjemis',      pos: 'مهاجم',      posEn: 'FW', club: 'فروزينوني 🇮🇹',                caps: 9,   goals: 2, age: 23 },
  ],
}

/**
 * بناء رد نصي جميل عن تشكيلة الجزائر في كأس العالم 2026
 * يدعم عرض الإصابة/الانسحاب مع مصادر FIFA
...
export function buildAlgeriaWC2026SquadResponse(section = 'full') {
  ...
  const statusPlayers = players.filter(p => p.status)
  const hasStatus     = statusPlayers.length > 0

  const tableRow = (p) => {
    const badge   = p.status ? ` ${_STATUS_BADGE[p.status] ?? '⚪'}` : ''
    const nameCol = `**${p.name}**${badge}`
    if (!hasStatus) {
      return `| ${nameCol} | ${p.pos} | ${p.club} | ${p.caps} | ${p.goals} | ${p.num} |`
    }
    if (!p.status) {
      return `| ${nameCol} | ${p.pos} | ${p.club} | ${p.caps} | ${p.goals} | ${p.num} | — |`
    }
    const label   = _STATUS_LABEL[p.status] ?? p.status
    const note    = p.statusNote  ? `: ${p.statusNote}`              : ''
    const repl    = p.replacedBy  ? ` · بديله: **${p.replacedBy}**` : ''
    const replFor = p.replacedFor ? ` عن: **${p.replacedFor}**`      : ''
    const src     = p.statusSource
      ? ` · [🔗 FIFA](${p.statusSource})`
      : ''
    return `| ${nameCol} | ${p.pos} | ${p.club} | ${p.caps} | ${p.goals} | ${p.num} | **${label}**${note}${repl}${replFor}${src} |`
  }

  const hdrCols = hasStatus
    ? `| اللاعب | المركز | النادي | المباريات | الأهداف | # | الحالة |\n|--------|--------|--------|-----------|---------|---|--------|`
    : `| اللاعب | المركز | النادي | المباريات | الأهداف | # |\n|--------|--------|--------|-----------|---------|---|`

  const injuredCount     = statusPlayers.filter(p => p.status === 'injured').length
  const withdrawnCount   = statusPlayers.filter(p => p.status === 'withdrawn').length
  const replacementCount = statusPlayers.filter(p => p.status === 'replacement').length
  const doubtCount       = statusPlayers.filter(p => p.status === 'doubt').length
  ...
  const lines = [
    ...
    ``,
    ...(hasStatus ? [
      `> 🔴 إصابة · ❌ انسحاب · 🔄 بديل · 🟡 في الشك`,
      `> ⚠️ معلومات الإصابة/الانسحاب مُستندة إلى إعلانات FIFA والـ FAF الرسمية`,
      ``,
    ] : []),
    `---`,
    ``,
    ...
    (hasStatus
      ? `\n> ${injuredCount ? `🔴 ${injuredCount} إصابة` : ''}${withdrawnCount ? ` · ❌ ${withdrawnCount} انسحاب` : ''}${replacementCount ? ` · 🔄 ${replacementCount} بديل` : ''}${doubtCount ? ` · 🟡 ${doubtCount} في الشك` : ''}`
      : ''),
    ``,
...
// Updated: 2026-06-14 via kooora.com official squads page
// ═══════════════════════════════════════════════════════════════════
export const WC2026_ALL_SQUADS = {
  ...
  'جنوب إفريقيا': {flag:'🇿🇦', group:'A', players:[
    {pos:'GK',name:'رونوين ويليامز',club:''},
    {pos:'GK',name:'ريكاردو جوس',club:''},
    {pos:'GK',name:'سيبهو تشايني',club:''},
    {pos:'DEF',name:'خوليسو موداو',club:''},
    {pos:'DEF',name:'ثابانج ماتولودي',club:''},
    {pos:'DEF',name:'كاموجيلو سيبيليبيلي',club:''},
    {pos:'DEF',name:'أوبري موديبا',club:''},
    {pos:'DEF',name:'أولويثو ماخانيا',club:''},
    {pos:'DEF',name:'برادلي كروس',club:''},
    {pos:'DEF',name:'ساموكيلو كابيني',club:''},
    {pos:'DEF',name:'خولوماني نداماني',club:''},
    {pos:'DEF',name:'مبيكيزيلي مبوكازي',club:''},
    {pos:'DEF',name:'إيمي أوكون',club:''},
    {pos:'DEF',name:'نكوسيناثي سيبيسي',club:''},
    {pos:'MID',name:'تيبوهو موكوينا',club:''},
    {pos:'MID',name:'سبيهليلو سيثولي',club:''},
    {pos:'MID',name:'جايدن آدامز',club:''},
    {pos:'MID',name:'ثالينتي مباثا',club:''},
    {pos:'FWD',name:'لايل فوستر',club:''},
    {pos:'FWD',name:'إكرام راينرز',club:''},
    {pos:'FWD',name:'ريليبو هيل موفوكينج',club:''},
    {pos:'FWD',name:'تشيبانج موريمي',club:''},
    {pos:'FWD',name:'إيفيدنس ماكجوبا',club:''},
    {pos:'FWD',name:'ثيمبا زواني',club:''},
    {pos:'FWD',name:'أوسوين أبوليس',club:''},
    {pos:'FWD',name:'ثابيلو ماسيكو',club:''},
  ]},
  'كوريا الجنوبية': {flag:'🇰🇷', group:'A', players:[
    {pos:'GK',name:'جوي هيون وو',club:''},
    {pos:'GK',name:'كيم سيونج جيو',club:''},
    {pos:'GK',name:'سونج بوم كيون',club:''},
    {pos:'DEF',name:'كيم مين جاي',club:''},
    {pos:'DEF',name:'تشو يو مين',club:''},
    {pos:'DEF',name:'لي هان بيوم',club:''},
    {pos:'DEF',name:'كيم تاي هيون',club:''},
    {pos:'DEF',name:'بارك جين سيوب',club:''},
    {pos:'DEF',name:'لي جي هيوك',club:''},
    {pos:'DEF',name:'لي تاي سيوك',club:''},
    {pos:'DEF',name:'سيول يونج وو',club:''},
    {pos:'DEF',name:'ينس كاستروب',club:''},
    {pos:'DEF',name:'كيم مون هوان',club:''},
    {pos:'MID',name:'يانج هيون جون',club:''},
    {pos:'MID',name:'بايك سيونج هو',club:''},
    {pos:'MID',name:'هوانج إن بيوم',club:''},
    {pos:'MID',name:'كيم جين جيو',club:''},
    {pos:'MID',name:'باي جون هو',club:''},
    {pos:'MID',name:'يوم جي سونج',club:''},
    {pos:'MID',name:'هوانج هي تشان',club:''},
    {pos:'MID',name:'لي دونج جيونج',club:''},
    {pos:'MID',name:'لي جاي سونج',club:''},
    {pos:'MID',name:'لي كانج إن',club:''},
    {pos:'FWD',name:'أو هيون جيو',club:''},
    {pos:'FWD',name:'سون هيونج مين',club:''},
    {pos:'FWD',name:'تشو جوي سونج',club:''},
  ]},
  'التشيك': {flag:'🇨🇿', group:'A', players:[
    {pos:'GK',name:'لوكاش هورنيتشيك',club:''},
    {pos:'GK',name:'ماتيي كوفار',club:''},
    {pos:'GK',name:'يندريخ ستانيك',club:''},
    {pos:'DEF',name:'فلاديمير تسوفال',club:''},
    {pos:'DEF',name:'دافيد دوديرا',club:''},
    {pos:'DEF',name:'توماش هوليش',club:''},
    {pos:'DEF',name:'روبن هراناتش',club:''},
    {pos:'DEF',name:'شتيبان خالوبيك',club:''},
    {pos:'DEF',name:'دافيد يوراسِك',club:''},
    {pos:'DEF',name:'لاديسلاف كريتشي',club:''},
    {pos:'DEF',name:'ياروسلاف زيليني',club:''},
    {pos:'DEF',name:'دافيد زيما',club:''},
    {pos:'MID',name:'لوكاش تشيرف',club:''},
    {pos:'MID',name:'فلاديمير داريدا',club:''},
    {pos:'MID',name:'لوكاش بروفود',club:''},
    {pos:'MID',name:'ميخال ساديليك',club:''},
    {pos:'MID',name:'هوغو سوخورِك',club:''},
    {pos:'MID',name:'ألكسندر سويكا',club:''},
    {pos:'MID',name:'توماس سوتشيك',club:''},
    {pos:'MID',name:'بافيل شولتس',club:''},
    {pos:'MID',name:'دينيس فيسينسكي',club:''},
    {pos:'FWD',name:'آدم هلوجيك',club:''},
    {pos:'FWD',name:'توماش خوري',club:''},
    {pos:'FWD',name:'مويمير خيتيل',club:''},
    {pos:'FWD',name:'يان كوختا',club:''},
    {pos:'FWD',name:'باتريك شيك',club:''},
  ]},
  'كندا': {flag:'🇨🇦', group:'B', players:[
    {pos:'GK',name:'ماكسيم كريبو',club:''},
    {pos:'GK',name:'أوين جودمان',club:''},
    {pos:'GK',name:'داين سان كلير',club:''},
    {pos:'DEF',name:'ألفونسو ديفيز',club:''},
    {pos:'DEF',name:'أليستر جونستون',club:''},
    {pos:'DEF',name:'ريتشي لاريا',club:''},
    {pos:'DEF',name:'نيكو سيجور',club:''},
    {pos:'DEF',name:'مويس بومبيتو',club:''},
    {pos:'DEF',name:'ديريك كورنيليوس',club:''},
    {pos:'DEF',name:'لوك دي فوجيروليس',club:''},
    {pos:'DEF',name:'ألفي جونز',club:''},
    {pos:'DEF',name:'جويل ووترمان',club:''},
    {pos:'MID',name:'ماتيو شوينيير',club:''},
    {pos:'MID',name:'ستيفن يستاكيو',club:''},
    {pos:'MID',name:'إسماعيل كوني',club:''},
    {pos:'MID',name:'جوناثان أوسوريو',club:''},
    {pos:'MID',name:'نيثان ساليبا',club:''},
    {pos:'MID',name:'علي أحمد',club:''},
    {pos:'MID',name:'تاجون بوكانان',club:''},
    {pos:'MID',name:'مارسيلو فلوريس',club:''},
    {pos:'MID',name:'ليام ميلار',club:''},
    {pos:'MID',name:'جاكوب شافلبورج',club:''},
    {pos:'FWD',name:'جوناثان ديفيد',club:''},
    {pos:'FWD',name:'بروميس ديفيد',club:''},
    {pos:'FWD',name:'سايل لارين',club:''},
    {pos:'FWD',name:'تاني أولواسي',club:''},
  ]},
  ...
  'قطر': {flag:'🇶🇦', group:'B', players:[
    {pos:'GK',name:'مشعل برشم',club:''},
    {pos:'GK',name:'محمود أبو ندى',club:''},
    {pos:'GK',name:'صلاح زكريا',club:''},
    {pos:'DEF',name:'أيوب العلوي',club:''},
    {pos:'DEF',name:'بوعلام خوخي',club:''},
    {pos:'DEF',name:'همام الأمين',club:''},
    {pos:'DEF',name:'لوكاس مينديس',club:''},
    {pos:'DEF',name:'عيسى لاي',club:''},
    {pos:'DEF',name:'بيدرو ميجيل',club:''},
    {pos:'DEF',name:'الهاشمي الحسين',club:''},
    {pos:'DEF',name:'سلطان البريك',club:''},
    {pos:'MID',name:'عاصم ماديبو',club:''},
    {pos:'MID',name:'عبد العزيز حاتم',club:''},
    {pos:'MID',name:'أحمد فتحي',club:''},
    {pos:'MID',name:'كريم بوضياف',club:''},
    {pos:'MID',name:'جاسم جابر',club:''},
    {pos:'MID',name:'محمد مناعي',club:''},
    {pos:'FWD',name:'أحمد الجانحي',club:''},
    {pos:'FWD',name:'أحمد علاء',club:''},
    {pos:'FWD',name:'أكرم عفيف',club:''},
    {pos:'FWD',name:'المعز علي',club:''},
    {pos:'FWD',name:'إدميلسون جونيور',club:''},
    {pos:'FWD',name:'حسن الهيدوس',club:''},
    {pos:'FWD',name:'محمد منتاري',club:''},
    {pos:'FWD',name:'تحسين محمد',club:''},
    {pos:'FWD',name:'يوسف عبد الرازق',club:''},
  ]},
  ...
  'الولايات المتحدة الأمريكية': {flag:'🇺🇸', group:'D', players:[
  ...
  'باراجواي': {flag:'🇵🇾', group:'D', players:[
    {pos:'GK',name:'أورلاندو جيل',club:''},
    {pos:'GK',name:'روبرتو فرنانديز',club:''},
    {pos:'GK',name:'جاستون أولفيرا',club:''},
    {pos:'DEF',name:'خوان كاسيريس',club:''},
    {pos:'DEF',name:'جوستافو فيلاسكيز',club:''},
    {pos:'DEF',name:'جوستافو جوميز',club:''},
    {pos:'DEF',name:'جونيور ألونسو',club:''},
    {pos:'DEF',name:'خوسيه كانالي',club:''},
    {pos:'DEF',name:'عمر ألديريتي',club:''},
    {pos:'DEF',name:'ألكسندرو مايدانا',club:''},
    {pos:'DEF',name:'فابيان بالبوينا',club:''},
    {pos:'MID',name:'دييجو جوميز',club:''},
    {pos:'MID',name:'ماوريسيو ماجاليس',club:''},
    {pos:'MID',name:'داميان بوباديلا',club:''},
    {pos:'MID',name:'برايان أوجيدا',club:''},
    {pos:'MID',name:'أندريس كوباس',club:''},
    {pos:'MID',name:'ماتياس جالارزا',club:''},
    {pos:'MID',name:'أليخاندرو جامارا',club:''},
    {pos:'FWD',name:'جوستافو كاباليرو',club:''},
    {pos:'FWD',name:'رامون سوسا',club:''},
    {pos:'FWD',name:'أليكس أرسي',club:''},
    {pos:'FWD',name:'إيسيدرو بيتا',club:''},
    {pos:'FWD',name:'جابرييل أفالوس',club:''},
    {pos:'FWD',name:'ميجيل ألميرون',club:''},
    {pos:'FWD',name:'خوليو إنسيسو',club:''},
    {pos:'FWD',name:'أنطونيو سانابريا',club:''},
  ]},
  'أستراليا': {flag:'🇦🇺', group:'D', players:[
    {pos:'GK',name:'باتريك بيتش',club:''},
    {pos:'GK',name:'بول إيزو',club:''},
    {pos:'GK',name:'ماثيو رايان',club:''},
    {pos:'DEF',name:'عزيز بيهيتش',club:''},
    {pos:'DEF',name:'جوردان بوس',club:''},
    {pos:'DEF',name:'كاميرون بيرجيس',club:''},
    {pos:'DEF',name:'أليساندرو سيركاتي',club:''},
    {pos:'DEF',name:'ميلوش ديجينك',club:''},
    {pos:'DEF',name:'جايسون جيريا',club:''},
    {pos:'DEF',name:'لوكاس هيرينجتون',club:''},
    {pos:'DEF',name:'جاكوب إيتاليانو',club:''},
    {pos:'DEF',name:'هاري سوتار',club:''},
    {pos:'DEF',name:'كاي تروين',club:''},
    {pos:'MID',name:'كاميرون ديفلين',club:''},
    {pos:'MID',name:'أيدين هروستيتش',club:''},
    {pos:'MID',name:'جاكسون إيرفين',club:''},
    {pos:'MID',name:'كونور ميتكالف',club:''},
    {pos:'MID',name:'بول أوكون-إنجستلر',club:''},
    {pos:'MID',name:'أيدين أونيل',club:''},
    {pos:'FWD',name:'نيستوري إرانكوندا',club:''},
    {pos:'FWD',name:'ماثيو ليكي',club:''},
    {pos:'FWD',name:'أوير مابيل',club:''},
    {pos:'FWD',name:'محمد توري',club:''},
    {pos:'FWD',name:'نيشان فيلوبيللاي',club:''},
    {pos:'FWD',name:'كريستيان فولباتو',club:''},
    {pos:'FWD',name:'تيتي ينجي',club:''},
  ]},
  'تركيا': {flag:'🇹🇷', group:'D', players:[
    {pos:'GK',name:'ألتاي بايندير',club:''},
    {pos:'GK',name:'ميرت جونوك',club:''},
    {pos:'GK',name:'أوجورجان تشاكير',club:''},
    {pos:'DEF',name:'عبد الكريم برداقجي',club:''},
    {pos:'DEF',name:'أميريح ديميريل',club:''},
    {pos:'DEF',name:'تشاجلار سويونشو',club:''},
    {pos:'DEF',name:'إرين إلمالي',club:''},
    {pos:'DEF',name:'فيردي كاديوغلو',club:''},
    {pos:'DEF',name:'ميرت مولدور',club:''},
    {pos:'DEF',name:'أوزان كاباك',club:''},
    {pos:'DEF',name:'سامت أكايدين',club:''},
    {pos:'DEF',name:'زكي تشيليك',club:''},
    {pos:'MID',name:'هاكان تشالهان أوجلو',club:''},
    {pos:'MID',name:'إسماعيل يوكسيك',club:''},
    {pos:'MID',name:'كان أيهان',club:''},
    {pos:'MID',name:'أوركون كوتشكو',club:''},
    {pos:'MID',name:'صالح أوزكان',club:''},
    {pos:'FWD',name:'أردا جولر',club:''},
    {pos:'FWD',name:'باريس ألبر يلماز',club:''},
    {pos:'FWD',name:'جان أوزون',club:''},
    {pos:'FWD',name:'دينيز جول',club:''},
    {pos:'FWD',name:'عرفان جان كاهفيجي',club:''},
    {pos:'FWD',name:'كينان يلديز',club:''},
    {pos:'FWD',name:'كريم أكتوركوجلو',club:''},
    {pos:'FWD',name:'أوجوز أيدين',club:''},
    {pos:'FWD',name:'يونس أكجون',club:''},
  ]},
  'ألمانيا': {flag:'🇩🇪', group:'E', players:[
    {pos:'GK',name:'أوليفر بومان',club:''},
    {pos:'GK',name:'مانويل نوير',club:''},
    {pos:'GK',name:'ألكسندر نوبل',club:''},
    {pos:'DEF',name:'فالديمار أنطون',club:''},
    {pos:'DEF',name:'ناثانيال براون',club:''},
    {pos:'DEF',name:'جوشوا كيميتش',club:''},
    {pos:'DEF',name:'ديفيد راوم',club:''},
    {pos:'DEF',name:'أنطونيو روديجر',club:''},
    {pos:'DEF',name:'نيكو شلوتربيك',club:''},
    {pos:'DEF',name:'جوناثان تاه',club:''},
    {pos:'DEF',name:'مالك ثياو',club:''},
    {pos:'MID',name:'نديم أميري',club:''},
    {pos:'MID',name:'ليون جوريتسكا',club:''},
    {pos:'MID',name:'باسكال جروس',club:''},
    {pos:'MID',name:'لينارت كارل',club:''},
    {pos:'MID',name:'جيمي ليولينج',club:''},
    {pos:'MID',name:'جمال موسيالا',club:''},
    {pos:'MID',name:'فيليكس نميشا',club:''},
    {pos:'MID',name:'ألكسندر بافلوفيتش',club:''},
    {pos:'MID',name:'ليروي ساني',club:''},
    {pos:'MID',name:'أنجيلو ستيلر',club:''},
    {pos:'MID',name:'فلوريان فيرتز',club:''},
    {pos:'FWD',name:'ماكسيميليان بيير',club:''},
    {pos:'FWD',name:'كاي هافيرتز',club:''},
    {pos:'FWD',name:'دنيز أونداف',club:''},
    {pos:'FWD',name:'نيك فولتماده',club:''},
  ]},
  ...
  'كوت ديفوار': {flag:'🇨🇮', group:'E', players:[
    {pos:'GK',name:'يحيى فوفانا',club:''},
    {pos:'GK',name:'محمد كوني',club:''},
    {pos:'GK',name:'ألبان لافون',club:''},
    {pos:'DEF',name:'إيمانويل أجبادو',club:''},
    {pos:'DEF',name:'جيلا دوي',club:''},
    {pos:'DEF',name:'عثمان ديوماندي',club:''},
    {pos:'DEF',name:'جيسلان كونان',club:''},
    {pos:'DEF',name:'أوديلون كوسونو',club:''},
    {pos:'DEF',name:'إيفان نديكا',club:''},
    {pos:'DEF',name:'ويلفريد سينجو',club:''},
    {pos:'MID',name:'سيكو فوفانا',club:''},
    {pos:'MID',name:'بارفيه جويجون',club:''},
    {pos:'MID',name:'فرانك كيسي',club:''},
    {pos:'MID',name:'كريست أولاي',club:''},
    {pos:'MID',name:'إبراهيم سنجاري',club:''},
    {pos:'MID',name:'جان ميشيل سيري',club:''},
    {pos:'FWD',name:'سيمون أدينجرا',club:''},
    {pos:'FWD',name:'أنجي يوان بوني',club:''},
    {pos:'FWD',name:'أماد ديالو',club:''},
    {pos:'FWD',name:'عمر دياكيتي',club:''},
    {pos:'FWD',name:'يان ديوماندي',club:''},
    {pos:'FWD',name:'إيفان جيساند',club:''},
    {pos:'FWD',name:'نيكولاس بيبي',club:''},
    {pos:'FWD',name:'بازومانا توري',club:''},
    {pos:'FWD',name:'إيلي واهي',club:''},
  ]},
  ...
  'اليابان': {flag:'🇯🇵', group:'F', players:[
    {pos:'GK',name:'زيون سوزوكي',club:''},
    {pos:'GK',name:'كيسوكي أوساكو',club:''},
    {pos:'GK',name:'توموكي هاياكاو',club:''},
    {pos:'DEF',name:'يوكيناري سوجاوارا',club:''},
    {pos:'DEF',name:'تاكيهيرو تومياسو',club:''},
    {pos:'DEF',name:'كو إيتاكورا',club:''},
    {pos:'DEF',name:'هيروكي إيتو',club:''},
    {pos:'DEF',name:'تسويوشي واتانابي',club:''},
    {pos:'DEF',name:'شوجو تانيجوتشي',club:''},
    {pos:'DEF',name:'أيومو سيكو',club:''},
    {pos:'DEF',name:'يوتو ناجاتومو',club:''},
    {pos:'DEF',name:'جونوسوكي سوزوكي',club:''},
    {pos:'MID',name:'واتارو إندو',club:''},
    {pos:'MID',name:'كايشو سانو',club:''},
    {pos:'MID',name:'آو تاناكا',club:''},
    {pos:'MID',name:'دايتشي كامادا',club:''},
    {pos:'MID',name:'ريتسو دوان',club:''},
    {pos:'MID',name:'جونيا إيتو',club:''},
    {pos:'MID',name:'تاكيفوسا كوبو',club:''},
    {pos:'MID',name:'كيتو ناكامورا',club:''},
    {pos:'FWD',name:'أياسي أويدا',club:''},
    {pos:'FWD',name:'كوكي أوجاوا',club:''},
    {pos:'FWD',name:'كينتو شيوجاي',club:''},
    {pos:'FWD',name:'يويتو سوزوكي',club:''},
    {pos:'FWD',name:'كيسوكي جوتو',club:''},
    {pos:'FWD',name:'دايزن مايدا',club:''},
  ]},
  ...
  'بلجيكا': {flag:'🇧🇪', group:'G', players:[
    {pos:'GK',name:'تيبو كورتوا',club:''},
    {pos:'GK',name:'سين لامينس',club:''},
    {pos:'GK',name:'مايك بيندرز',club:''},
    {pos:'DEF',name:'آرثر ثيات',club:''},
    {pos:'DEF',name:'براندون ميشيل',club:''},
    {pos:'DEF',name:'ناثان نجوي',club:''},
    {pos:'DEF',name:'كوني دي وينتر',club:''},
    {pos:'DEF',name:'خواكين سيس',club:''},
    {pos:'DEF',name:'زينو ديباست',club:''},
    {pos:'DEF',name:'مكسيم دي كويبر',club:''},
    {pos:'DEF',name:'توماس مونييه',club:''},
    {pos:'DEF',name:'تيموثي كاستانيي',club:''},
    {pos:'MID',name:'نيكولاس راسكين',club:''},
    {pos:'MID',name:'أكسل فيتسل',club:''},
    {pos:'MID',name:'هانز فاناكين',club:''},
    {pos:'MID',name:'يوري تيليمانس',club:''},
    {pos:'MID',name:'أمادو أونانا',club:''},
    {pos:'MID',name:'كيفين دي بروين',club:''},
    {pos:'FWD',name:'جيريمي دوكو',club:''},
    {pos:'FWD',name:'أليكسيس ساليميكرز',club:''},
    {pos:'FWD',name:'روميلو لوكاكو',club:''},
    {pos:'FWD',name:'دودي لوكيباكيو',club:''},
    {pos:'FWD',name:'ماتياس فرنانديز باردو',club:''},
    {pos:'FWD',name:'دييجو موريرا',club:''},
    {pos:'FWD',name:'لياندرو تروسارد',club:''},
    {pos:'FWD',name:'تشارلز دي كيتيلير',club:''},
  ]},
  ...
  'كاب فيردي': {flag:'🇨🇻', group:'H', players:[
  ...
  'السعودية': {flag:'🇸🇦', group:'H', players:[
    {pos:'GK',name:'محمد العويس',club:''},
    {pos:'GK',name:'نواف العقيدي',club:''},
    {pos:'GK',name:'أحمد الكسار',club:''},
    {pos:'GK',name:'عبد القدوس عطية',club:''},
    {pos:'DEF',name:'عبد الإله العمري',club:''},
    {pos:'DEF',name:'حسان تمبكتي',club:''},
    {pos:'DEF',name:'جهاد ذكري',club:''},
    {pos:'DEF',name:'علي لاجامي',club:''},
    {pos:'DEF',name:'حسن كادش',club:''},
    {pos:'DEF',name:'سعود عبد الحميد',club:''},
    {pos:'MID',name:'محمد كنو',club:''},
    {pos:'MID',name:'عبد الله الخيبري',club:''},
    {pos:'MID',name:'زياد الجهني',club:''},
    {pos:'MID',name:'ناصر الدوسري',club:''},
    {pos:'MID',name:'مصعب الجوير',club:''},
    {pos:'MID',name:'علاء آل حجي',club:''},
    {pos:'MID',name:'سالم الدوسري',club:''},
    {pos:'MID',name:'خالد الغنام',club:''},
    {pos:'MID',name:'أيمن يحيى',club:''},
    {pos:'MID',name:'سلطان مندش',club:''},
    {pos:'MID',name:'صالح أبو الشامات',club:''},
    {pos:'FWD',name:'فراس البريكان',club:''},
    {pos:'FWD',name:'عبد الله آل سالم',club:''},
    {pos:'FWD',name:'صالح الشهري',club:''},
    {pos:'FWD',name:'عبد الله الحمدان',club:''},
  ]},
  'أوروجواي': {flag:'🇺🇾', group:'H', players:[
    ...
    {pos:'MID',name:'ماتياس فينيا',club:'ريفر بليت'},
  ...
  'فرنسا': {flag:'🇫🇷', group:'I', players:[
    ...
    {pos:'FWD',name:'عثمان ديمبيلي',club:'باريس سان جيرمان (فرنسا)',status:'doubt',statusNote:'ألم عضلي قبيل انطلاق البطولة — وضعه قيد المتابعة',statusSource:'https://www.fifa.com/fifaplus/ar/tournaments/mens/worldcup/canadamexicousa2026/teams/france'},
  ...
  'السنغال': {flag:'🇸🇳', group:'I', players:[
    {pos:'GK',name:'إدوارد ميندي',club:''},
    {pos:'GK',name:'موري دياو',club:''},
    {pos:'GK',name:'إيفان ضيوف',club:''},
    {pos:'DEF',name:'كريبين دياتا',club:''},
    {pos:'DEF',name:'أنتوني ميندي',club:''},
    {pos:'DEF',name:'كاليدو كوليبالي',club:''},
    {pos:'DEF',name:'الحاج مالك ضيوف',club:''},
    {pos:'DEF',name:'مامادو سار',club:''},
    {pos:'DEF',name:'موسى نياكاتي',club:''},
    {pos:'DEF',name:'مصطفى مبو',club:''},
    {pos:'DEF',name:'عبدولاي سيك',club:''},
    {pos:'DEF',name:'إسماعيل جاكوبس',club:''},
    {pos:'DEF',name:'إيلاي كمارا',club:''},
    {pos:'MID',name:'إدريسا جانا جاي',club:''},
    {pos:'MID',name:'بابي جاي',club:''},
    {pos:'MID',name:'لامين كمارا',club:''},
    {pos:'MID',name:'حبيب ديارا',club:''},
    {pos:'MID',name:'باتي سيس',club:''},
    {pos:'MID',name:'بابي متار سار',club:''},
    {pos:'MID',name:'بارا سابوكو ندياي',club:''},
    {pos:'FWD',name:'ساديو ماني',club:''},
    {pos:'FWD',name:'إسماعيلا سار',club:''},
    {pos:'FWD',name:'إيلمان ندياي',club:''},
    {pos:'FWD',name:'أساني دياو',club:''},
    {pos:'FWD',name:'إبراهيم مباي',club:''},
    {pos:'FWD',name:'نيكولاس جاكسون',club:''},
    {pos:'FWD',name:'بامبا ديانج',club:''},
    {pos:'FWD',name:'شريف ندياي',club:''},
  ]},
  ...
  'الأرجنتين': {flag:'🇦🇷', group:'J', players:[
    {pos:'GK',name:'إيميليانو مارتينيز',club:'أستون فيلا'},
    {pos:'GK',name:'جيرونيمو رولي',club:'مونتيري'},
    {pos:'GK',name:'خوان موسو',club:'أتلانتا يونايتد'},
    {pos:'DEF',name:'كريستيان روميرو',club:'توتنهام'},
    {pos:'DEF',name:'ليساندرو مارتينيز',club:'مانشستر يونايتد'},
    {pos:'DEF',name:'ليوناردو باليردي',club:'أتلتيكو مدريد'},
    {pos:'DEF',name:'نيكولاس أوتاميندي',club:'بنفيكا'},
    {pos:'DEF',name:'نيكولاس تاليافيكو',club:'أولمبيك ليون'},
    {pos:'DEF',name:'فاكوندو ميدينا',club:'لوس أنجلوس FC'},
    {pos:'DEF',name:'جونزالو مونتيل',club:'نوتنغهام فورست'},
    {pos:'DEF',name:'ناهويل مولينا',club:'أتلتيكو مدريد'},
    {pos:'DEF',name:'فالنتين باركو',club:'برايتون'},
    {pos:'MID',name:'إنزو فرنانديز',club:'تشيلسي'},
    {pos:'MID',name:'رودريجو دي بول',club:'أتلتيكو مدريد'},
    {pos:'MID',name:'أليكسيس ماك أليستر',club:'ليفربول'},
    {pos:'MID',name:'لياندرو باريديس',club:'روما'},
    {pos:'MID',name:'إيزيكويل بالاسيوس',club:'باير ليفركوزن'},
    {pos:'MID',name:'جيوفاني لو سيلسو',club:'توتنهام'},
    {pos:'MID',name:'نيكولا باز',club:'بوكا جونيورز'},
    {pos:'MID',name:'تياجو ألمادا',club:'بوتافوغو'},
    {pos:'MID',name:'جوليانو سيميوني',club:'أتلتيكو مدريد'},
    {pos:'MID',name:'نيكولاس جونزاليس',club:'يوفنتوس'},
    {pos:'FWD',name:'ليونيل ميسي',club:'إنتر ميامي'},
    {pos:'FWD',name:'لاوتارو مارتينيز',club:'إنتر ميلان'},
    {pos:'FWD',name:'خوسيه مانويل لوبيز',club:'راسينغ كلوب'},
    {pos:'FWD',name:'جوليان ألفاريز',club:'أتلتيكو مدريد'},
  ]},
  ...
  'النمسا': {flag:'🇦🇹', group:'J', players:[
    ...
    {pos:'DEF',name:'ديفيد ألابا',club:'ريال مدريد',status:'injured',statusNote:'إصابة في الرباط الصليبي (ديسمبر 2023) — عودة غير مؤكدة',statusSource:'https://www.fifa.com/fifaplus/ar/tournaments/mens/worldcup/canadamexicousa2026/teams/austria'},
  ...
  'البرتغال': {flag:'🇵🇹', group:'K', players:[
    {pos:'GK',name:'ديوجو كوستا',club:''},
    {pos:'GK',name:'خوسيه سا',club:''},
    {pos:'GK',name:'روي سيلفا',club:''},
    {pos:'GK',name:'ريكاردو فيلهو',club:''},
    {pos:'DEF',name:'ديوجو دالوت',club:''},
    {pos:'DEF',name:'نيلسون سيميدو',club:''},
    {pos:'DEF',name:'جواو كانسيلو',club:''},
    {pos:'DEF',name:'نونو مينديز',club:''},
    {pos:'DEF',name:'جونسالو إيناسيو',club:''},
    {pos:'DEF',name:'ريناتو فيجا',club:''},
    {pos:'DEF',name:'روبن دياز',club:''},
    {pos:'DEF',name:'توماس أراوخو',club:''},
    {pos:'DEF',name:'ماتيوس نونيز',club:''},
    {pos:'MID',name:'روبن نيفيز',club:''},
    {pos:'MID',name:'سامو كوستا',club:''},
    {pos:'MID',name:'جواو نيفيز',club:''},
    {pos:'MID',name:'فيتينيا',club:''},
    {pos:'MID',name:'برونو فيرنانديز',club:''},
    {pos:'MID',name:'برناردو سيلفا',club:''},
    {pos:'FWD',name:'جواو فيليكس',club:''},
    {pos:'FWD',name:'ترينكاو',club:''},
    {pos:'FWD',name:'فرانسيسكو كونسيساو',club:''},
    {pos:'FWD',name:'بيدرو نيتو',club:''},
    {pos:'FWD',name:'رافائيل لياو',club:''},
    {pos:'FWD',name:'جونسالو جيديش',club:''},
    {pos:'FWD',name:'جونزالو راموس',club:''},
    {pos:'FWD',name:'كريستيانو رونالدو',club:''},
  ]},
  ...
  'أوزباكستان': {flag:'🇺🇿', group:'K', players:[
...
export const WC2026_SQUAD_ALIASES = {
  // الولايات المتحدة
  'أمريكا':'الولايات المتحدة الأمريكية','الأمريكا':'الولايات المتحدة الأمريكية',
  'الولايات المتحدة':'الولايات المتحدة الأمريكية','usa':'الولايات المتحدة الأمريكية',
  'الولايات المتحده':'الولايات المتحدة الأمريكية',
  // كوريا
  'كوريا':'كوريا الجنوبية','الكورية':'كوريا الجنوبية','كوريا جنوبية':'كوريا الجنوبية',
  // إسبانيا
  'اسبانيا':'إسبانيا','اسباني':'إسبانيا','اسبانيا':'إسبانيا',
  // إنجلترا
  'انجلترا':'إنجلترا','إنجليزي':'إنجلترا',
  // ألمانيا
  'المانيا':'ألمانيا','الألمانيا':'ألمانيا','المانيا':'ألمانيا',
  // الجزائر — فصحى
  'جزائر':'الجزائر','الخضر':'الجزائر','المنتخب الجزائري':'الجزائر',
  'دز':'الجزائر','dz':'الجزائر','الجزائري':'الجزائر',
  'محرز':'الجزائر','بن سبعيني':'الجزائر','آيت نوري':'الجزائر',
  'مازة':'الجزائر','عوار':'الجزائر','شايبي':'الجزائر',
  // الجزائر — دارجة
  'الخضرة':'الجزائر','الخضار':'الجزائر','منتخبنا':'الجزائر',
  'خضرنا':'الجزائر','كروسة':'الجزائر','الكرو':'الجزائر',
  'بيتكوفيتش':'الجزائر','بيتكو':'الجزائر',
  'فريق الجزائر':'الجزائر','الفنيق':'الجزائر',
  // المغرب
  'المغربي':'المغرب','أسود الأطلس':'المغرب','المغرب الأقصى':'المغرب',
  // البرتغال
  'برتغال':'البرتغال','رونالدو':'البرتغال','البرتغالي':'البرتغال',
  // الأرجنتين
  'أرجنتين':'الأرجنتين','الأرجنتيني':'الأرجنتين','ارجنتين':'الأرجنتين',
  'ميسي':'الأرجنتين',
  // مصر
  'صلاح':'مصر','الفراعنة':'مصر','المصري':'مصر',
  // السعودية
  'السعودي':'السعودية','الاخضر السعودي':'السعودية','المنتخب السعودي':'السعودية',
  // قطر
  'العنابي':'قطر','القطري':'قطر',
  // تونس
  'نسور قرطاج':'تونس','التونسي':'تونس',
  // البوسنة
  'البوسنة':'البوسنة والهرسك','بوسنة':'البوسنة والهرسك','البوسنة والهرسك':'البوسنة والهرسك',
  // التشيك
  'جمهورية التشيك':'التشيك','تشيك':'التشيك','التشيكي':'التشيك',
  // أستراليا
  'استراليا':'أستراليا','اوستراليا':'أستراليا',
  // أوروجواي
  'اوروغواي':'أوروجواي','اوروجواي':'أوروجواي','أوروغواي':'أوروجواي',
  // إيران
  'ايران':'إيران','الإيراني':'إيران',
  // نيوزيلندا
  'نيوزيلاندا':'نيوزيلندا','نيوزلندا':'نيوزيلندا',
  // الكونغو الديمقراطية
  'الكونغو':'الكونغو الديمقراطية','كونغو':'الكونغو الديمقراطية','الكنغو':'الكونغو الديمقراطية',
  'الكونغو الديموقراطية':'الكونغو الديمقراطية',
  // أوزباكستان
  'اوزبكستان':'أوزباكستان','أوزبكستان':'أوزباكستان','اوزباكستان':'أوزباكستان',
  // كوت ديفوار
  'ساحل العاج':'كوت ديفوار','الفيل':'كوت ديفوار',
  // الإكوادور
  'اكوادور':'الإكوادور','اكودور':'الإكوادور','الاكوادور':'الإكوادور','اكوادور':'الإكوادور',
  // جنوب أفريقيا (تحت الاسمين)
  'جنوب افريقيا':'جنوب إفريقيا','جنوب أفريقيا':'جنوب إفريقيا',
  // كاب فيردي
  'الرأس الأخضر':'كاب فيردي','راس اخضر':'كاب فيردي','رأس أخضر':'كاب فيردي','كاب فردي':'كاب فيردي',
  // اليابان
  'الساموراي':'اليابان','ياباني':'اليابان','اليابانيون':'اليابان',
  // البرازيل
  'برازيل':'البرازيل','نيمار':'البرازيل','فينيسيوس':'البرازيل','فينيشيوس':'البرازيل',
  // فرنسا
  'مبابي':'فرنسا','فرنسي':'فرنسا','الديوك':'فرنسا',
  // إسبانيا
  'يامال':'إسبانيا','بيدري':'إسبانيا','مويا':'إسبانيا',
  // النرويج
  'هالاند':'النرويج','نرويج':'النرويج',
  // هولندا
  'هولاندا':'هولندا','هوlandا':'هولندا','الهولندي':'هولندا',
  // اسكتلندا
  'اسكتلندا':'اسكتلندا','سكوتلندا':'اسكتلندا','اسكتلانда':'اسكتلندا',
  // السنغال
  'سنغال':'السنغال','اسود التيرانجا':'السنغال','التيرانجا':'السنغال',
  // العراق
  'العراقي':'العراق','اسود الرافدين':'العراق',
  // كرواتيا
  'كروتيا':'كرواتيا','كروواتيا':'كرواتيا','المربعات':'كرواتيا',
  // غانا
  'غانا':'غانا','النجوم السود':'غانا',
}
...
export function isWC2026SquadQuery(q = '') {
  ...
  // Squad/lineup keywords — covers natural language patterns including position queries
  const hasSquad = new RegExp(
    'تشكيل|قائمة|' +
    'لاعب(?:ي|ين|ون|و|)|' +
    'أسماء.*(?:لاعب|منتخب)|' +
    'مَن.*(?:يمثل|يشارك|مستدعى|استدعى|في القائمة|سيلعب|يلعب)|' +
    'من.*(?:يمثل|يشارك|مستدعى|استدعى|في القائمة|سيلعب|يلعب|هو حارس|هم اللاعب)|' +
    'أعضاء.*منتخب|أفراد.*منتخب|مجموعة اللاعبين|' +
    'الـ\\s*26|26\\s*لاعب|الطاقم|الفريق الوطني|المنتخب الوطني|' +
    // Position-based queries: "من هو حارس المرمى / المهاجم / المدافع"
    'حارس(?:\\s+المرمى)?|الحراس|حراس المرمى|' +
    'مهاجم(?:ون|ين|و|ي)?|المهاجم(?:ون|ين)|' +
    'مدافع(?:ون|ين|و|ي)?|المدافع(?:ون|ين)|' +
    'لاعب(?:و|ي|ون)\\s+الوسط|وسط(?:يون|يين)|' +
    // Participation queries
    'مشارك(?:ون|ين|ة)?|مشارك في|يمثل|يمثلون|' +
    'من يمثل|من يشارك|من سيشارك|من يلعب|' +
    // ── دارجة جزائرية ──
    'شكيل(?:ة|ات)?|' +                          // شكيلة (dialect for تشكيلة)
    'منو\\s*(?:يلعب|فيهم|ف\\s*القائمة|دعا|جاب)|' + // منو يلعب / منو دعاهم
    'واش\\s*(?:راهم|يلعبو|عندنا|جابو)|' +      // واش راهم اللاعبين
    'كروسة|الكرو|' +                             // كروسة / الكرو (عامي)
    'لاعبي\\s*(?:الخضر|الجزائر|المنتخب)|' +   // لاعبي الخضر
    'دعا(?:هم)?\\s*(?:بيتكو|المدرب)|' +        // دعاهم بيتكوفيتش
    'قائمة\\s*(?:بيتكو|المدرب|الوطني)|' +      // قائمة بيتكو
    'كاش\\s*(?:تشكيل|قائمة)'                   // كاش تشكيلة (= هل هناك)
  ).test(t)
...
// ══════════════════════════════════════════════════════════════════════════════
// PLAYER STATUS SYSTEM — حقول حالة اللاعب (إصابة / انسحاب / بديل)
// ══════════════════════════════════════════════════════════════════════════════
// حقول اختيارية تُضاف لأي لاعب في WC2026_ALL_SQUADS أو WC2026_ALGERIA_SQUAD:
//   status       : 'injured' | 'withdrawn' | 'replacement' | 'doubt'
//   statusNote   : نص وصف الإصابة/الانسحاب بالعربية
//   statusSource : رابط FIFA أو المصدر الرسمي
//   replacedBy   : اسم اللاعب البديل (اختياري — للمُصاب/المنسحب)
//   replacedFor  : اسم اللاعب الذي حلّ محله (للبدلاء فقط)
// ══════════════════════════════════════════════════════════════════════════════
 ...
 * يدعم حقول الإصابة/الانسحاب مع مصادر FIFA
 */
export function buildWC2026SquadResponse(teamName = '') {
  ...
  const row = (p) => {
    const badge = p.status ? ` ${_STATUS_BADGE[p.status] ?? '⚪'}` : ''
    const name  = `${p.name}${badge}`
    if (!hasStatus) return `| ${name} | ${p.club} |`
    if (!p.status)  return `| ${name} | ${p.club} | — |`
    const label   = _STATUS_LABEL[p.status] ?? p.status
    const note    = p.statusNote  ? `: ${p.statusNote}`                : ''
    const repl    = p.replacedBy  ? ` · بديله: **${p.replacedBy}**`   : ''
    const replFor = p.replacedFor ? ` عن: **${p.replacedFor}**`        : ''
    const src     = p.statusSource
      ? ` · [🔗 FIFA](${p.statusSource})`
      : ''
    return `| ${name} | ${p.club} | **${label}**${note}${repl}${replFor}${src} |`
  }

  const hdr = hasStatus
    ? `| اللاعب | النادي | الحالة |\n|--------|--------|--------|`
    : `| اللاعب | النادي |\n|--------|--------|`
  ...
  const lines = [
    ...
    `> **المصدر:** [كووورة](https://www.kooora.com) · [FIFA الرسمي](https://www.fifa.com/fifaplus/ar/tournaments/mens/worldcup/canadamexicousa2026/teams) — يونيو 2026`,
    ``,
    ...(hasStatus ? [
      `> 🔴 إصابة · ❌ انسحاب · 🔄 بديل · 🟡 في الشك`,
      `> ⚠️ معلومات الإصابة/الانسحاب مُستندة إلى إعلانات FIFA الرسمية`,
      ``,
    ] : []),
    `---`,
    ``,
    ...
    ``,
    `---`,
    `📊 **الإجمالي:** ${players.length} لاعباً` +
    (hasStatus
      ? ` · ${injuredCount ? `🔴 ${injuredCount} إصابة` : ''}${withdrawnCount ? ` · ❌ ${withdrawnCount} انسحاب` : ''}${replacementCount ? ` · 🔄 ${replacementCount} بديل` : ''}${doubtCount ? ` · 🟡 ${doubtCount} في الشك` : ''}`
      : '') +
    ` | 🔗 [FIFA](https://www.fifa.com/fifaplus/ar/tournaments/mens/worldcup/canadamexicousa2026/teams)`,
  ]
  return lines.join('\n')
}
...
// ═══════════════════════════════════════════════════════════════════
// WC2026 SQUAD PROMPTS — أسئلة متوقعة عن تشكيلات كأس العالم 2026
// كل سؤال يُرتبط بـ handler موجود في server.js → buildWC2026SquadResponse
// ═══════════════════════════════════════════════════════════════════
export const WC2026_SQUAD_PROMPTS = [
  // تشكيلات الجزائر
  'تشكيلة الجزائر في كأس العالم 2026',
  'قائمة لاعبي الجزائر في مونديال 2026',
  'من هم لاعبو المنتخب الجزائري في كأس العالم 2026؟',
  'ما هي تشكيلة الخضر في كأس العالم 2026؟',
  'أسماء لاعبي الجزائر في المونديال',
  'من استدعاهم بيتكوفيتش لكأس العالم 2026؟',
  'هل رياض محرز في قائمة الجزائر لكأس العالم 2026؟',
  'هل إبراهيم مازة في تشكيلة الجزائر؟',
  'هل رامي بن سبعيني ضمن قائمة الجزائر؟',
  'لاعبو الجزائر في المجموعة J',
  // الأرجنتين وميسي
  'تشكيلة الأرجنتين في كأس العالم 2026',
  'من هم لاعبو الأرجنتين في المونديال 2026؟',
  'هل ميسي في قائمة الأرجنتين لكأس العالم 2026؟',
  'قائمة الأرجنتين الرسمية لكأس العالم 2026',
  'لاعبو الأرجنتين في المجموعة J',
  // فرنسا
  'تشكيلة فرنسا في كأس العالم 2026',
  'قائمة لاعبي فرنسا في المونديال 2026',
  'هل مبابي في قائمة فرنسا؟',
  'لاعبو فرنسا في المجموعة I',
  // البرازيل
  'تشكيلة البرازيل في كأس العالم 2026',
  'لاعبو البرازيل في المجموعة C',
  'هل نيمار في قائمة البرازيل لكأس العالم 2026؟',
  // إسبانيا
  'تشكيلة إسبانيا في كأس العالم 2026',
  'قائمة لاعبي إسبانيا في المونديال 2026',
  'هل يامال في قائمة إسبانيا؟',
  'لاعبو إسبانيا في المجموعة H',
  // المغرب
  'تشكيلة المغرب في كأس العالم 2026',
  'قائمة أسود الأطلس في المونديال 2026',
  'لاعبو المغرب في المجموعة C',
  // مصر
  'تشكيلة مصر في كأس العالم 2026',
  'قائمة الفراعنة في المونديال 2026',
  'هل محمد صلاح في قائمة مصر؟',
  'لاعبو مصر في المجموعة G',
  // السعودية
  'تشكيلة السعودية في كأس العالم 2026',
  'قائمة الأخضر السعودي في المونديال',
  'لاعبو السعودية في المجموعة H',
  // تونس
  'تشكيلة تونس في كأس العالم 2026',
  'قائمة نسور قرطاج في المونديال 2026',
  'لاعبو تونس في المجموعة F',
  // ألمانيا
  'تشكيلة ألمانيا في كأس العالم 2026',
  'قائمة لاعبي ألمانيا في المونديال',
  'لاعبو ألمانيا في المجموعة E',
  // إنجلترا
  'تشكيلة إنجلترا في كأس العالم 2026',
  'قائمة لاعبي إنجلترا في المونديال',
  'لاعبو إنجلترا في المجموعة L',
  // البرتغال
  'تشكيلة البرتغال في كأس العالم 2026',
  'قائمة لاعبي البرتغال في المونديال',
  'هل رونالدو في قائمة البرتغال لكأس العالم 2026؟',
  'لاعبو البرتغال في المجموعة K',
  // هولندا
  'تشكيلة هولندا في كأس العالم 2026',
  'قائمة لاعبي هولندا في المونديال',
  'لاعبو هولندا في المجموعة F',
  // النرويج
  'تشكيلة النرويج في كأس العالم 2026',
  'هل هالاند في قائمة النرويج لكأس العالم 2026؟',
  'لاعبو النرويج في المجموعة I',
  // اليابان
  'تشكيلة اليابان في كأس العالم 2026',
  'قائمة الساموراي في المونديال 2026',
  'لاعبو اليابان في المجموعة F',
  // كرواتيا
  'تشكيلة كرواتيا في كأس العالم 2026',
  'قائمة لاعبي كرواتيا في المونديال',
  'لاعبو كرواتيا في المجموعة L',
  // بلجيكا
  'تشكيلة بلجيكا في كأس العالم 2026',
  'قائمة لاعبي بلجيكا في المونديال',
  'لاعبو بلجيكا في المجموعة G',
  // قطر
  'تشكيلة قطر في كأس العالم 2026',
  'قائمة العنابي في المونديال',
  'لاعبو قطر في المجموعة B',
  // العراق
  'تشكيلة العراق في كأس العالم 2026',
  'قائمة أسود الرافدين في المونديال',
  'لاعبو العراق في المجموعة I',
  // السنغال
  'تشكيلة السنغال في كأس العالم 2026',
  'قائمة التيرانجا في المونديال',
  'لاعبو السنغال في المجموعة I',
  // كولومبيا
  'تشكيلة كولومبيا في كأس العالم 2026',
  'قائمة لاعبي كولومبيا في المونديال',
  'لاعبو كولومبيا في المجموعة K',
  // البوسنة
  'تشكيلة البوسنة والهرسك في كأس العالم 2026',
  'قائمة لاعبي البوسنة في المونديال',
  'لاعبو البوسنة في المجموعة B',
  // كندا
  'تشكيلة كندا في كأس العالم 2026',
  'قائمة لاعبي كندا في المونديال',
  'لاعبو كندا في المجموعة B',
  // الولايات المتحدة
  'تشكيلة الولايات المتحدة في كأس العالم 2026',
  'قائمة لاعبي أمريكا في المونديال',
  'لاعبو الولايات المتحدة في المجموعة D',
  // سويسرا
  'تشكيلة سويسرا في كأس العالم 2026',
  'قائمة لاعبي سويسرا في المونديال',
  'لاعبو سويسرا في المجموعة B',
  // المكسيك
  'تشكيلة المكسيك في كأس العالم 2026',
  'قائمة لاعبي المكسيك في المونديال',
  'لاعبو المكسيك في المجموعة A',
  // أسئلة عامة
  'تشكيلات الفرق في كأس العالم 2026',
  'قوائم المنتخبات في مونديال 2026',
  'من يمثل المغرب العربي في كأس العالم 2026؟',
  'ما هي الدول العربية المشاركة في كأس العالم 2026؟',
  'من يشارك من إفريقيا في كأس العالم 2026؟',
  'أكثر الدول تمثيلاً في كأس العالم 2026',
  'لاعبون جزائريون في الدوري الفرنسي يشاركون في المونديال',
  'لاعبو الدوري السعودي في كأس العالم 2026',
]
