...
// Updated: 2026-06-13 via automated scraping
// ═══════════════════════════════════════════════════════════════════
export const WC2026_ALL_SQUADS = {
  'المكسيك': { flag:'🇲🇽', group:'A', players:[
    ...
    {pos:'MID',name:'أوبيد فارغاس',club:'أتلتيكو مدريد 🇪🇸'},
  ]},
  ...
  'السويد': { flag:'🇸🇪', group:'F', players:[
    {pos:'GK',name:'فيكتور يوهانسون',club:'ستوك سيتي 🏴󠁧󠁢󠁥󠁮󠁧󠁿'},
    {pos:'GK',name:'كريستوفر نوردفيلت',club:'AIK سولنا 🇸🇪'},
    {pos:'GK',name:'جاكوب ويدل زيترستروم',club:'ديربي كاونتي 🏴󠁧󠁢󠁥󠁮󠁧󠁿'},
    {pos:'DEF',name:'هيالمار إيكدال',club:'بيرنلي 🏴󠁧󠁢󠁥󠁮󠁧󠁿'},
    {pos:'DEF',name:'جابرييل غودموندسون',club:'ليدز يونايتد 🏴󠁧󠁢󠁥󠁮󠁧󠁿'},
    {pos:'DEF',name:'إيزاك هين',club:'أتالانتا 🇮🇹'},
    {pos:'DEF',name:'فيكتور ليندلوف',club:'مانشستر يونايتد 🏴󠁧󠁢󠁥󠁮󠁧󠁿'},
    {pos:'DEF',name:'كارل ستارفيلت',club:'كلوب بروج 🇧🇪'},
    {pos:'DEF',name:'إريك سميث',club:'سانت باولي 🇩🇪'},
    {pos:'DEF',name:'دانييل سفنسون',club:'كوبنهاغن 🇩🇰'},
    {pos:'DEF',name:'غوستاف لاجيربيلكه',club:'سيلتيك 🏴󠁧󠁢󠁳󠁣󠁴󠁿'},
    {pos:'DEF',name:'هيرمان يوهانسون',club:'دييف 🇸🇪'},
    {pos:'MID',name:'لوكاس بيرغفال',club:'توتنهام هوتسبر 🏴󠁧󠁢󠁥󠁮󠁧󠁿'},
    {pos:'MID',name:'ياسين عياري',club:'برايتون 🏴󠁧󠁢󠁥󠁮󠁧󠁿'},
    {pos:'MID',name:'ماتياس سفانبرغ',club:'فولفسبورغ 🇩🇪'},
    {pos:'MID',name:'صمويل أديووومي',club:'ليدز يونايتد 🏴󠁧󠁢󠁥󠁮󠁧󠁿'},
    {pos:'MID',name:'جيسبر كارلسون',club:'بولونيا 🇮🇹'},
    {pos:'MID',name:'ألبين إيكدال',club:'لاتسيو 🇮🇹'},
    {pos:'FWD',name:'فيكتور غيوكيريس',club:'أرسنال 🏴󠁧󠁢󠁥󠁮󠁧󠁿'},
    {pos:'FWD',name:'ألكسندر إيزاك',club:'ليفربول 🏴󠁧󠁢󠁥󠁮󠁧󠁿'},
    {pos:'FWD',name:'أنتوني إيلانغا',club:'نيوكاسل يونايتد 🏴󠁧󠁢󠁥󠁮󠁧󠁿'},
    {pos:'FWD',name:'إيميل كرافت',club:'نيوكاسل يونايتد 🏴󠁧󠁢󠁥󠁮󠁧󠁿'},
    {pos:'FWD',name:'روبن كويسون',club:'بالرمو 🇮🇹'},
    {pos:'FWD',name:'باتريك فاليمارك',club:'فيينورد 🇳🇱'},
    {pos:'FWD',name:'لويس ميروشنيشيني',club:'مالمو 🇸🇪'},
    {pos:'FWD',name:'هيوغو أونان',club:'ديف 🇸🇪'},
  ]},
  ...
  'إيران': { flag:'🇮🇷', group:'G', players:[
    {pos:'GK',name:'عليرضا بيرانوند',club:'تراكتور تبريز 🇮🇷'},
    {pos:'GK',name:'حسين حسيني',club:'سباهان أصفهان 🇮🇷'},
    {pos:'GK',name:'بيام نيازمند',club:'الاستقلال طهران 🇮🇷'},
    {pos:'DEF',name:'إحسان حاج صفي',club:'فولفسبورغ 🇩🇪'},
    {pos:'DEF',name:'ميلاد محمدي',club:'كاربا كويوبيو 🇫🇮'},
    {pos:'DEF',name:'رامين رضاييان',club:'سبا بطرسبورغ 🇷🇺'},
    {pos:'DEF',name:'شجاع خليل‌زاده',club:'آل نصر 🇸🇦'},
    {pos:'DEF',name:'حسين كنعاني',club:'الاستقلال طهران 🇮🇷'},
    {pos:'DEF',name:'علي نعمتي',club:'تراكتور تبريز 🇮🇷'},
    {pos:'DEF',name:'دانيال عيري',club:'سباهان أصفهان 🇮🇷'},
    {pos:'DEF',name:'صالح هرداني',club:'سباهان أصفهان 🇮🇷'},
    {pos:'MID',name:'سامان قدوس',club:'كالبا 🇦🇪'},
    {pos:'MID',name:'سعيد عزت اللهي',club:'شباب الأهلي 🇦🇪'},
    {pos:'MID',name:'روزبه شيشمي',club:'الاستقلال طهران 🇮🇷'},
    {pos:'MID',name:'علي رضا جهانبخش',club:'فيينورد 🇳🇱'},
    {pos:'MID',name:'مهدي قايدي',club:'شباب الأهلي 🇦🇪'},
    {pos:'MID',name:'مهدي ترابي',club:'سباهان أصفهان 🇮🇷'},
    {pos:'MID',name:'آريا يوسفي',club:'سباهان أصفهان 🇮🇷'},
    {pos:'MID',name:'أمير محمد رزاقي نيا',club:'سباهان أصفهان 🇮🇷'},
    {pos:'MID',name:'محمد غوربان',club:'تراكتور تبريز 🇮🇷'},
    {pos:'MID',name:'محمد مهبي',club:'الفتح 🇸🇦'},
    {pos:'FWD',name:'مهدي طارمي',club:'أولمبياكوس 🇬🇷'},
    {pos:'FWD',name:'دنيس دارغاهي',club:'ستاندار لييج 🇧🇪'},
    {pos:'FWD',name:'علي عليپور',club:'كروو 🇧🇪'},
    {pos:'FWD',name:'أمير حسين حسين‌زاده',club:'الاستقلال طهران 🇮🇷'},
    {pos:'FWD',name:'مهدي قيدي',club:'الاستقلال طهران 🇮🇷'},
  ]},
  'نيوزيلندا': { flag:'🇳🇿', group:'G', players:[
    {pos:'GK',name:'ماكس كروكومبي',club:'ميلوول 🏴󠁧󠁢󠁥󠁮󠁧󠁿'},
    {pos:'GK',name:'أليكس بولسن',club:'مانسفيلد تاون 🏴󠁧󠁢󠁥󠁮󠁧󠁿'},
    {pos:'GK',name:'أوليفر وود',club:'ويلينغتون فينيكس 🇳🇿'},
    {pos:'DEF',name:'تايلر بيندون',club:'نوتنغهام فورست 🏴󠁧󠁢󠁥󠁮󠁧󠁿'},
    {pos:'DEF',name:'مايكل بوكسال',club:'مينيسوتا يونايتد 🇺🇸'},
    {pos:'DEF',name:'ليبراتو كاتشي',club:'ريكسام 🏴󠁧󠁢󠁷󠁬󠁳󠁿'},
    {pos:'DEF',name:'فرانسيس دي فريس',club:'أوكلاند FC 🇳🇿'},
    {pos:'DEF',name:'كالان إليوت',club:'أوكلاند FC 🇳🇿'},
    {pos:'DEF',name:'تيم بين',club:'ويلينغتون فينيكس 🇳🇿'},
    {pos:'DEF',name:'ناندو بيجناكر',club:'أوكلاند FC 🇳🇿'},
    {pos:'DEF',name:'تومي سميث',club:'برينتري تاون 🏴󠁧󠁢󠁥󠁮󠁧󠁿'},
    {pos:'DEF',name:'فين سورمان',club:'بورتلاند تيمبرز 🇺🇸'},
    {pos:'MID',name:'جو بيل',club:'فايكنغ 🇳🇴'},
    {pos:'MID',name:'مات جاربيت',club:'بيترباره يونايتد 🏴󠁧󠁢󠁥󠁮󠁧󠁿'},
    {pos:'MID',name:'أليكس روفر',club:'ويلينغتون فينيكس 🇳🇿'},
    {pos:'MID',name:'ساربريت سينغ',club:'ويلينغتون فينيكس 🇳🇿'},
    {pos:'MID',name:'ماركو ستامينيك',club:'سوانسي سيتي 🏴󠁧󠁢󠁷󠁬󠁳󠁿'},
    {pos:'MID',name:'رايان توماس',club:'PEC زفولي 🇳🇱'},
    {pos:'FWD',name:'كريس وود',club:'نوتنغهام فورست 🏴󠁧󠁢󠁥󠁮󠁧󠁿'},
    {pos:'FWD',name:'كوستا بارباروسيس',club:'ويسترن سيدني واندريرز 🇦🇺'},
    {pos:'FWD',name:'لاكلان بيليس',club:'نيوكاسل جيتس 🇦🇺'},
    {pos:'FWD',name:'إيلاي جاست',club:'مذرويل 🏴󠁧󠁢󠁳󠁣󠁴󠁿'},
    {pos:'FWD',name:'كالام ماكوات',club:'سيلكيبورغ 🇩🇰'},
    {pos:'FWD',name:'بن أولد',club:'سانت إيتيان 🇫🇷'},
    {pos:'FWD',name:'جيسي راندال',club:'أوكلاند FC 🇳🇿'},
    {pos:'FWD',name:'بن وين',club:'بورت فيل 🏴󠁧󠁢󠁥󠁮󠁧󠁿'},
  ]},
  ...
  'الرأس الأخضر': { flag:'🇨🇻', group:'H', players:[
    {pos:'GK',name:'فوزينيا',club:'سبورتينغ برابانسيا 🇨🇻'},
    {pos:'GK',name:'كارلوس سانتوس',club:'سان دييغو FC 🇺🇸'},
    {pos:'GK',name:'ماركيو',club:'الأكاديميا أيلاند 🇨🇻'},
    {pos:'DEF',name:'لوجان كوستا',club:'فياريال 🇪🇸'},
    {pos:'DEF',name:'ستيفن موريرا',club:'كولومبوس كرو 🇺🇸'},
    {pos:'DEF',name:'واغنر بينا',club:'طرابزون سبور 🇹🇷'},
    {pos:'DEF',name:'جواو باولو فيرنانديس',club:'FCSB 🇷🇴'},
    {pos:'DEF',name:'سيدني كابرال',club:'بنفيكا 🇵🇹'},
    {pos:'DEF',name:'روبيرتو بيكو لوبيس',club:'شامروك روفرز 🇮🇪'},
    {pos:'DEF',name:'كيلفين بيريس',club:'SJK سيناييوكي 🇫🇮'},
    {pos:'DEF',name:'ستوبيرا',club:'توريسيني 🇵🇹'},
    {pos:'DEF',name:'إيديلسون ديني',club:'البطائح 🇦🇪'},
    {pos:'MID',name:'جاميرو مونتيرو',club:'PEC زفولي 🇳🇱'},
    {pos:'MID',name:'تيلمو أركانجو',club:'فيتوريا غيماريش 🇵🇹'},
    {pos:'MID',name:'كلاوديو كوليلا',club:'سبورتينغ لشبونة 🇵🇹'},
    {pos:'MID',name:'دياني فانتيني',club:'أودينيزي 🇮🇹'},
    {pos:'MID',name:'ريان مينديس',club:'فينورد 🇳🇱'},
    {pos:'MID',name:'أنتونيو ميندس',club:'النادي الأهلي 🇪🇬'},
    {pos:'MID',name:'برنارد بينيفيدس',club:'فيجي 🇫🇯'},
    {pos:'FWD',name:'جاري رودريجيس',club:'غلطة سراي 🇹🇷'},
    {pos:'FWD',name:'كيلفين دياس',club:'بانفيلد 🇦🇷'},
    {pos:'FWD',name:'كيلي فيليكس',club:'حيفا 🇮🇱'},
    {pos:'FWD',name:'جاليشيو باتيستا',club:'التعاون 🇸🇦'},
    {pos:'FWD',name:'برايان روديريجس',club:'فاريزي 🇮🇹'},
    {pos:'FWD',name:'كيفين بريما',club:'سبورتينغ لشبونة 🇵🇹'},
    {pos:'FWD',name:'داريو بارتولومو',club:'سيانتوس 🇫🇷'},
  ]},
  ...
  'أوروجواي': { flag:'🇺🇾', group:'H', players:[
    ...
    {pos:'MID',name:'إيميليانو مارتينيز',club:'فلامنجو 🇧🇷'},
    {pos:'MID',name:'ماتياس فينيا',club:'رين 🇫🇷'},
    ...
    {pos:'MID',name:'كريستيان أوليفيرا',club:'مونتيري 🇲🇽'},
    {pos:'MID',name:'فاكوندو بيليستري',club:'أوساسونا 🇪🇸'},
  ]},
  ...
  'الجزائر': { flag:'🇩🇿', group:'J', players:[
    ...
    {pos:'GK',name:'ملفان ماستيل',club:'باير ليفركوزن'},
  ...
  'النمسا': { flag:'🇦🇹', group:'J', players:[
    {pos:'GK',name:'ألكسندر شلاجر',club:'ريد بول سالزبورغ 🇦🇹'},
    {pos:'GK',name:'باتريك بينتز',club:'بروندبي 🇩🇰'},
    {pos:'GK',name:'فلوريان فييجيلي',club:'فيكتوريا بلزن 🇨🇿'},
    {pos:'DEF',name:'ديفيد ألابا',club:'ريال مدريد 🇪🇸'},
    {pos:'DEF',name:'كيفين دانسو',club:'توتنهام هوتسبر 🏴󠁧󠁢󠁥󠁮󠁧󠁿'},
    {pos:'DEF',name:'ستيفان بوش',club:'ماينتس 05 🇩🇪'},
    {pos:'DEF',name:'فيليب لينهارت',club:'فرايبورغ 🇩🇪'},
    {pos:'DEF',name:'فيليب مويني',club:'ماينتس 05 🇩🇪'},
    {pos:'DEF',name:'ألكسندر براس',club:'هوفنهايم 🇩🇪'},
    {pos:'DEF',name:'ماركو فريدل',club:'فيردر بريمن 🇩🇪'},
    {pos:'DEF',name:'مايكل سفوبودا',club:'فينيزيا 🇮🇹'},
    {pos:'DEF',name:'ديفيد أفينجروبر',club:'إيلشي 🇪🇸'},
    {pos:'MID',name:'مارسيل سابيتزر',club:'بوروسيا دورتموند 🇩🇪'},
    {pos:'MID',name:'كزافر شلاجر',club:'RB لايبزيغ 🇩🇪'},
    {pos:'MID',name:'نيكولاس زيفالد',club:'RB لايبزيغ 🇩🇪'},
    {pos:'MID',name:'كريستوف باومجارتنر',club:'RB لايبزيغ 🇩🇪'},
    {pos:'MID',name:'كونراد لايمر',club:'بايرن ميونيخ 🇩🇪'},
    {pos:'MID',name:'كارني تشوكويميكا',club:'بوروسيا دورتموند 🇩🇪'},
    {pos:'MID',name:'رومانو شميد',club:'فيردر بريمن 🇩🇪'},
    {pos:'MID',name:'فلوريان جريليتش',club:'براغا 🇵🇹'},
    {pos:'MID',name:'باتريك فيمر',club:'فولفسبورغ 🇩🇪'},
    {pos:'MID',name:'بول وانر',club:'PSV أيندهوفن 🇳🇱'},
    {pos:'MID',name:'أليساندرو شوبف',club:'شالكه 04 🇩🇪'},
    {pos:'FWD',name:'ماركو أرناوتوفيتش',club:'إنتر ميلان 🇮🇹'},
    {pos:'FWD',name:'ميكائيل جريجوريتش',club:'موناكو 🇫🇷'},
    {pos:'FWD',name:'ساشا كالايدجيتش',club:'سيلتيك 🏴󠁧󠁢󠁳󠁣󠁴󠁿'},
  ]},
  'الأردن': { flag:'🇯🇴', group:'J', players:[
    {pos:'GK',name:'يزيد أبو ليلى',club:'الحسين الأردني 🇯🇴'},
    {pos:'GK',name:'عبدالله الفاخوري',club:'الوحدات 🇯🇴'},
    {pos:'GK',name:'نور بني عطية',club:'الفيصلي 🇯🇴'},
    {pos:'DEF',name:'إحسان حداد',club:'الحسين الأردني 🇯🇴'},
    {pos:'DEF',name:'محمد أبو النادي',club:'الجزيرة 🇯🇴'},
    {pos:'DEF',name:'حسام أبو الذهب',club:'الوحدات 🇯🇴'},
    {pos:'DEF',name:'محمد أبو حشيش',club:'الفيصلي 🇯🇴'},
    {pos:'DEF',name:'مهند أبو طه',club:'القادسية 🇸🇦'},
    {pos:'DEF',name:'يزن العرب',club:'الوحدات 🇯🇴'},
    {pos:'DEF',name:'سعد الروسان',club:'الرمثا 🇯🇴'},
    {pos:'DEF',name:'أنس بدوي',club:'الفيصلي 🇯🇴'},
    {pos:'DEF',name:'عبدالله نصيب',club:'الأردن 🇯🇴'},
    {pos:'DEF',name:'سليم عبيد',club:'سويفت هيسبيرانج 🇱🇺'},
    {pos:'MID',name:'محمد الداوود',club:'الحسين 🇯🇴'},
    {pos:'MID',name:'نزار الرشدان',club:'الوحدات 🇯🇴'},
    {pos:'MID',name:'نور الروابدة',club:'الفيصلي 🇯🇴'},
    {pos:'MID',name:'رجائي عايد',club:'الأهلي 🇯🇴'},
    {pos:'MID',name:'عامر جاموس',club:'الوحدات 🇯🇴'},
    {pos:'MID',name:'إبراهيم سعادة',club:'الوحدات 🇯🇴'},
    {pos:'MID',name:'محمود مرضي',club:'الفيصلي 🇯🇴'},
    {pos:'FWD',name:'محمد أبو زريق',club:'الجزيرة 🇯🇴'},
    {pos:'FWD',name:'موسى التعمري',club:'رين 🇫🇷'},
    {pos:'FWD',name:'علي عزايزة',club:'مكابي تل أبيب 🇮🇱'},
    {pos:'FWD',name:'عودة الفاخوري',club:'الوحدات 🇯🇴'},
    {pos:'FWD',name:'علي علوان',club:'السيلية 🇶🇦'},
    {pos:'FWD',name:'محمود المردي',club:'الفيصلي 🇯🇴'},
  ]},
  ...
  'أوزباكستان': { flag:'🇺🇿', group:'K', players:[
    {pos:'GK',name:'أوتكير يوسوبوف',club:'نفباهور نامانجان 🇺🇿'},
    {pos:'GK',name:'عبدالوهيد نيماتوف',club:'نصاف قرشي 🇺🇿'},
    {pos:'GK',name:'بوتيرالي إيرغاشيف',club:'AGMK 🇺🇿'},
    {pos:'DEF',name:'عبدوكودير خوسانوف',club:'مانشستر سيتي 🏴󠁧󠁢󠁥󠁮󠁧󠁿'},
    {pos:'DEF',name:'رستم أشورماتوف',club:'الاستقلال طهران 🇮🇷'},
    {pos:'DEF',name:'فاروخ سيفيف',club:'نفتشي 🇺🇿'},
    {pos:'DEF',name:'خوجياكبار عليجانوف',club:'بختكور طشقند 🇺🇿'},
    {pos:'DEF',name:'شيرزود نصر اللاييف',club:'نصاف قرشي 🇺🇿'},
    {pos:'DEF',name:'عمر إيشمورودوف',club:'نصاف قرشي 🇺🇿'},
    {pos:'DEF',name:'خوسنيدين عليكولوف',club:'ريزيسبور 🇹🇷'},
    {pos:'DEF',name:'إبراهيم خليل يلدوشيف',club:'نفتشي 🇺🇿'},
    {pos:'DEF',name:'إسلام توختاخوجاييف',club:'AGMK 🇺🇿'},
    {pos:'DEF',name:'غوليب غايبوللاييف',club:'نصاف قرشي 🇺🇿'},
    {pos:'MID',name:'أوتابيك شوكوروف',club:'بختكور طشقند 🇺🇿'},
    {pos:'MID',name:'جامشيد إيسكاندروف',club:'بختكور طشقند 🇺🇿'},
    {pos:'MID',name:'عباس بيك فايز اللاييف',club:'ألاني سبور 🇹🇷'},
    {pos:'MID',name:'جلال الدين مشاريبوف',club:'قيصري سبور 🇹🇷'},
    {pos:'MID',name:'أموندج دوستموراتوف',club:'بختكور طشقند 🇺🇿'},
    {pos:'MID',name:'ألكسي سيرغيف',club:'بختكور طشقند 🇺🇿'},
    {pos:'MID',name:'أبور رحمان إيسماتوف',club:'نفباهور 🇺🇿'},
    {pos:'FWD',name:'إلدور شومورودوف',club:'باشاكشهير 🇹🇷'},
    {pos:'FWD',name:'بهروز محمد علييف',club:'ذوب آهن أصفهان 🇮🇷'},
    {pos:'FWD',name:'أكمال شوكوروف',club:'نصاف قرشي 🇺🇿'},
    {pos:'FWD',name:'أولوغبيك قوسيموف',club:'جرجو 🇵🇱'},
    {pos:'FWD',name:'إسلام رازاقوف',club:'بختكور طشقند 🇺🇿'},
    {pos:'FWD',name:'فرحاد تاشكنتوف',club:'نفباهور نامانجان 🇺🇿'},
  ]},
  ...
  'غانا': { flag:'🇬🇭', group:'L', players:[
    ...
    {pos:'MID',name:'كوجو أوبونج بيبراه',club:'نيس 🇫🇷'},
    ...
    {pos:'MID',name:'كواسي سيبو',club:'ليستر سيتي 🏴󠁧󠁢󠁥󠁮󠁧󠁿'},
  ]},
...
export const WC2026_SQUAD_ALIASES = {
  'أمريكا':'الولايات المتحدة','الأمريكا':'الولايات المتحدة','الولايات المتحدة الأمريكية':'الولايات المتحدة','usa':'الولايات المتحدة',
  'كوريا':'كوريا الجنوبية','الكوري':'كوريا الجنوبية','كوريا جنوبية':'كوريا الجنوبية',
  'برازيل':'البرازيل','اسبانيا':'إسبانيا','اسباني':'إسبانيا','اسبانيا':'إسبانيا',
  'انجلترا':'إنجلترا','إنجليزي':'إنجلترا','المانيا':'ألمانيا','الألمانيا':'ألمانيا',
  'جزائر':'الجزائر','الخضر':'الجزائر','المنتخب الجزائري':'الجزائر','دز':'الجزائر','dz':'الجزائر',
  'المغربي':'المغرب','أسود الأطلس':'المغرب','المغرب الأقصى':'المغرب',
  'برتغال':'البرتغال','ميسي':'الأرجنتين','رونالدو':'البرتغال',
  'أرجنتين':'الأرجنتين','الأرجنتيني':'الأرجنتين','ارجنتين':'الأرجنتين',
  'صلاح':'مصر','الفراعنة':'مصر','السعودي':'السعودية','الاخضر السعودي':'السعودية','السعودية':'السعودية','المنتخب السعودي':'السعودية',
  'العنابي':'قطر','القطري':'قطر','نسور قرطاج':'تونس','التونسي':'تونس',
  'البوسنة':'البوسنة والهرسك','بوسنة':'البوسنة والهرسك',
  'التشيك':'التشيك','جمهورية التشيك':'التشيك','تشيك':'التشيك',
  'استراليا':'أستراليا','اوروغواي':'أوروجواي','اوروجواي':'أوروجواي','ايران':'إيران','نيوزيلاندا':'نيوزيلندا',
  ...
  'ساحل العاج':'كوت ديفوار','الفيل':'كوت ديفوار','كوت ديفوار':'كوت ديفوار',
  'اكوادور':'الإكوادور','اكودور':'الإكوادور','الاكوادور':'الإكوادور',
  'جنوب افريقيا':'جنوب أفريقيا','جنوب إفريقيا':'جنوب أفريقيا',
  'كاب فيردي':'الرأس الأخضر','راس اخضر':'الرأس الأخضر','رأس أخضر':'الرأس الأخضر',
  'الساموراي':'اليابان','ياباني':'اليابان',
  'هالاند':'النرويج','نيمار':'البرازيل','مبابي':'فرنسا','يامال':'إسبانيا',
  'محرز':'الجزائر','بن ناصر':'الجزائر','زيدان لوكا':'الجزائر',
  'مبابي':'فرنسا','فينيسيوس':'البرازيل','بيدري':'إسبانيا',
  'كوراساو':'كوراساو','بوسنة':'البوسنة والهرسك',
}
