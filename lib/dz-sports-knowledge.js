...
export const WC2026_ALL_SQUADS = {
  ...
  'أوروجواي': { flag:'🇺🇾', group:'H', players:[
    ...
    {pos:'MID',name:'ريال أوفييدو',club:''},
    {pos:'MID',name:'الهلال',club:''},
  ]},
  ...
  'الأردن': { flag:'🇯🇴', group:'J', players:[
    {pos:'GK',name:'يزيد أبو ليلى',club:''},
    {pos:'GK',name:'عبدالله الفاخوري',club:''},
    {pos:'GK',name:'نور بني عطية',club:''},
  ...
  'غانا': { flag:'🇬🇭', group:'L', players:[
    ...
    {pos:'MID',name:'سان باتريكس أثلتيك',club:''},
