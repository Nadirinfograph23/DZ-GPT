...
export const IMAGE_MODELS = [
  // ── Gemini Direct (Nano Banana) — مجاني بـ GEMINI_API_KEY ─────────────────
  { id: 'nano-banana',   label: '🍌 Nano Banana',   badge: 'FREE', tier: 'fast',    provider: 'gemini', geminiModel: 'gemini-2.0-flash-preview-image-generation', group: 'Google' },
  { id: 'nano-banana-2', label: '🍌 Nano Banana 2', badge: 'NEW',  tier: 'fast',    provider: 'gemini', geminiModel: 'gemini-2.5-flash-preview-05-20',            group: 'Google' },
