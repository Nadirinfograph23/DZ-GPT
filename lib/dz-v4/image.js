...
export const IMAGE_MODELS = [
  ...
  { id: 'sd35-medium',        label: '🖼️ Stable Diffusion 3.5 Medium',badge: '',      tier: 'fast',    provider: 'hf', hfUrl: 'https://router.huggingface.co/hf-inference/models/stabilityai/stable-diffusion-3.5-medium', group: 'DZ MEDIA' },
  { id: 'sdxl-lightning',     label: '⚡ SDXL Lightning',              badge: '',      tier: 'fast',    provider: 'hf', hfUrl: 'https://router.huggingface.co/hf-inference/models/ByteDance/SDXL-Lightning',              group: 'DZ MEDIA' },
  { id: 'juggernaut',         label: '💪 Juggernaut XL v9',            badge: '',      tier: 'fast',    provider: 'hf', hfUrl: 'https://router.huggingface.co/hf-inference/models/RunDiffusion/Juggernaut-XL-v9',          group: 'DZ MEDIA' },
  ...
  { id: 'playground',         label: '🎮 Playground v2.5',             badge: '',      tier: 'fast',    provider: 'hf', hfUrl: 'https://router.huggingface.co/hf-inference/models/playgroundai/playground-v2.5-1024px-aesthetic', group: 'DZ MEDIA' },
  // ── Pollinations (مجاني بدون token) ──────────────────────────────────────
  { id: 'flux',               label: '⚡ FLUX (Pollinations)',   badge: 'FREE',  tier: 'fast',    provider: 'pollinations', polModel: 'flux',         group: 'DZ MEDIA BASIC' },
  { id: 'turbo',              label: '🚀 Turbo (Pollinations)',  badge: 'FREE',  tier: 'fast',    provider: 'pollinations', polModel: 'turbo',        group: 'DZ MEDIA BASIC' },
  { id: 'flux-realism',       label: '📸 FLUX Realism',          badge: 'REAL',  tier: 'fast',    provider: 'pollinations', polModel: 'flux-realism', group: 'DZ MEDIA BASIC' },
  { id: 'flux-anime',         label: '🌸 FLUX Anime',            badge: '',      tier: 'fast',    provider: 'pollinations', polModel: 'flux-anime',   group: 'DZ MEDIA BASIC' },
  { id: 'flux-3d',            label: '🧊 FLUX 3D',               badge: '',      tier: 'fast',    provider: 'pollinations', polModel: 'flux-3d',      group: 'DZ MEDIA BASIC' },
]
