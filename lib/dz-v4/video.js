...
export const T2V_MODELS = [
  ...
  { id: 'ltx-fast',    ltxModel: 'ltx-2-3-fast', label: 'LTX 2.3 Fast',  badge: 'HD سريع', color: '#06b6d4', tier: 'fast',  provider: 'ltx' },
  ...
  { id: 'opensora',    label: 'Open-Sora 2.0', badge: 'مفتوح', color: '#84cc16', tier: 'fast', provider: 'opensora' },
  ...
  { id: 't2v-ms',      hfId: 'damo-vilab/text-to-video-ms-1.7b',  label: 'ModelScope',  badge: 'خفيف',  color: '#10b981', tier: 'fast', provider: 'hf' },
  { id: 'ltx-hf',      hfId: 'Lightricks/LTX-Video',              label: 'LTX HF',      badge: 'مجاني', color: '#8b5cf6', tier: 'fast', provider: 'hf' },
]

export const I2V_MODELS = [
  // ── LTX Video API ─────────────────────────────────────────────────────────
  { id: 'ltx-i2v-fast', ltxModel: 'ltx-2-3-fast', label: 'LTX 2.3 I2V Fast', badge: 'HD سريع', color: '#06b6d4', tier: 'fast',  provider: 'ltx' },
