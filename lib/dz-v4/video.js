...
const STORE            = new Map()
const TIMEOUT_LTX      = 120_000   // 2 دقيقة لـ LTX (synchronous)
const TIMEOUT_FAST     = 150_000   // 2.5 دقيقة لـ HF fast
const TIMEOUT_HEAVY    = 300_000   // 5 دقائق لـ HF heavy
...
export const T2V_MODELS = [
  { id: 'ltx-fast',    ltxModel: 'ltx-2-3-fast', label: 'LTX 2.3 Fast',  badge: 'سريع HD', color: '#06b6d4', tier: 'fast', provider: 'ltx' },
  { id: 'ltx-pro',     ltxModel: 'ltx-2-3-pro',  label: 'LTX 2.3 Pro',   badge: 'جودة 4K', color: '#8b5cf6', tier: 'heavy', provider: 'ltx' },
  { id: 'ltx-hf',      hfId: 'Lightricks/LTX-Video',                      label: 'LTX HF',       badge: 'مجاني',   color: '#8b5cf6', tier: 'fast',  provider: 'hf' },
  { id: 'animatediff', hfId: 'ByteDance/AnimateDiff-Lightning',            label: 'AnimateDiff',  badge: 'GIF',     color: '#f59e0b', tier: 'fast',  provider: 'hf' },
  { id: 't2v-ms',      hfId: 'damo-vilab/text-to-video-ms-1.7b',           label: 'ModelScope',   badge: 'خفيف',    color: '#84cc16', tier: 'fast',  provider: 'hf' },
  { id: 'wan2',        hfId: 'Wan-AI/Wan2.1-T2V-1.3B',                    label: 'Wan 2.1',      badge: 'سريع',    color: '#10b981', tier: 'fast',  provider: 'hf' },
  { id: 'skyreels',    hfId: 'Skywork/SkyReels-V2-DF-1.3B-540P',          label: 'SkyReels V2',  badge: 'جديد',    color: '#0ea5e9', tier: 'fast',  provider: 'hf' },
  { id: 'wan2-14b',    hfId: 'Wan-AI/Wan2.1-T2V-14B-Diffusers',           label: 'Wan 2.1 Pro',  badge: 'جودة',    color: '#06b6d4', tier: 'heavy', provider: 'hf' },
  { id: 'cogvideo',    hfId: 'THUDM/CogVideoX1.5-5B',                      label: 'CogVideoX',    badge: 'HD',      color: '#6366f1', tier: 'heavy', provider: 'hf' },
  { id: 'hunyuan',     hfId: 'tencent/HunyuanVideo',                       label: 'HunyuanVideo', badge: 'احترافي', color: '#ec4899', tier: 'heavy', provider: 'hf' },
]

export const I2V_MODELS = [
  { id: 'ltx-i2v-fast',  ltxModel: 'ltx-2-3-fast', label: 'LTX 2.3 I2V Fast', badge: 'سريع HD', color: '#06b6d4', tier: 'fast',  provider: 'ltx' },
  { id: 'ltx-i2v-pro',   ltxModel: 'ltx-2-3-pro',  label: 'LTX 2.3 I2V Pro',  badge: 'جودة 4K', color: '#8b5cf6', tier: 'heavy', provider: 'ltx' },
  { id: 'svd',            hfId: 'stabilityai/stable-video-diffusion-img2vid-xt-1-1', label: 'SVD XT',    badge: 'ناعم',   color: '#3b82f6', tier: 'fast',  provider: 'hf' },
  { id: 'ltx-i2v-hf',    hfId: 'Lightricks/LTX-Video',                             label: 'LTX HF',    badge: 'سريع',   color: '#8b5cf6', tier: 'fast',  provider: 'hf' },
  { id: 'i2vgen',         hfId: 'ali-vilab/i2vgen-xl',                              label: 'I2VGen-XL', badge: 'متوازن', color: '#0891b2', tier: 'fast',  provider: 'hf' },
  { id: 'animdiff2',      hfId: 'ByteDance/AnimateDiff-Lightning',                  label: 'AnimateDiff',badge: 'GIF',   color: '#f59e0b', tier: 'fast',  provider: 'hf' },
  { id: 'wan-i2v',        hfId: 'Wan-AI/Wan2.1-I2V-14B-720P-Diffusers',             label: 'Wan I2V',   badge: 'جودة',   color: '#10b981', tier: 'heavy', provider: 'hf' },
  { id: 'cogvideo-i2v',   hfId: 'THUDM/CogVideoX-5b-I2V',                           label: 'CogVideoX I2V', badge: 'HD',color: '#6366f1', tier: 'heavy', provider: 'hf' },
]
...
async function tryLTXTextToVideo(prompt, preferredId, ip) {
  ...
  for (const m of ltxModels) {
    ...
    console.log(`[T2V:LTX] جرّب ${m.label}...`)
    const result = await ltxT2V({
