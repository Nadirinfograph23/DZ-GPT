...
const DARIJA_HINTS_AR = [
  ...
  'شكون','قداش','بصاح','برشا','شوية','مزيان','صحيت','هاك','هاكي','هاكم',
...
const STYLE_TEMPLATES = {
  darija: {
    default:    'أجب بالدارجة الجزائرية الأصيلة. استخدم كلمات مثل: "كاين، ماكانش، راني، بزاف، واش، يلا، خويا، صحيت، مزيان، بصح، علاه، شكون، قداش، كيفاش، دابا، توا، هاك، تاع، وحدو". كن طبيعياً وقريباً كأنك صاحب.',
