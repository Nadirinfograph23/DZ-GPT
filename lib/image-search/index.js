...
export async function searchImages({ query, aiGenerate, limit = 6 }) {
  ...
  // ── بحث متوازٍ في المصادر الثلاثة: Wikimedia + Openverse + Pinterest ────────
  ...
  // دمج النتائج: Pinterest أولاً (نتائج بصرية أغنى) ثم Wikimedia ثم Openverse
  // نتناوب بين المصادر لضمان التنوع
  let merged = []
