...
/**
 * يستخرج أسئلة متعددة مفصولة بعلامات استفهام داخل رسالة واحدة
...
function extractInlineQuestions(msg) {
  ...
  const QUESTION_MARKERS = /(?:من|ما|كيف|أين|متى|لماذا|هل|كم|ماذا|what|who|how|when|where|why|which|qui|que|comment|quand|o[uù]|pourquoi|combien|رئيس|عاصمة|سكان|عملة|نظام|عدد|أكبر|أصغر|أفضل)/i
