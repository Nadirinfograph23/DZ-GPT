...
**TABLE GENERATION RULES (mandatory for structured data):**
  - ALWAYS use GFM markdown tables (| col | col |) for:
    • Doctor / physician / clinic listings → columns: الاسم | التخصص | المدينة | العنوان | الهاتف | المصدر
...
const INTENT_RECIPE = {
  ...
  github:     ['identity', 'core', 'reasoning', 'search', 'routing', 'format', 'code', 'safety', 'validation'],
