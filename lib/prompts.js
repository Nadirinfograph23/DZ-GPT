...
const INTENT_RECIPE = {
  general:    ['identity', 'execution', 'core', 'thinking', 'reasoning', 'algeria', 'memory', 'compression', 'format', 'safety', 'validation'],
  news:       ['identity', 'core', 'reasoning', 'algeria', 'search', 'format', 'safety', 'validation'],
  github:     ['identity', 'execution', 'languages', 'core', 'thinking', 'reasoning', 'github_agent', 'format', 'code', 'safety', 'validation', 'recovery'],
  builder:    ['identity', 'execution', 'languages', 'core', 'thinking', 'reasoning', 'format', 'code', 'routing', 'safety', 'validation'],
  structured: ['identity', 'core', 'reasoning', 'algeria', 'search', 'format', 'safety', 'validation'],
  deep:       ['identity', 'execution', 'core', 'thinking', 'reasoning', 'algeria', 'search', 'memory', 'compression', 'routing', 'format', 'safety', 'validation'],
  thinking:   ['identity', 'core', 'thinking', 'reasoning', 'algeria', 'search', 'validation', 'format', 'safety'],
  code:       ['identity', 'execution', 'languages', 'core', 'thinking', 'reasoning', 'format', 'code', 'routing', 'safety', 'validation'],
  chitchat:   ['identity', 'core', 'algeria', 'format', 'safety'],
  youtube:    ['identity', 'core', 'youtube', 'format', 'safety', 'validation'],
  prompt:     ['identity', 'core', 'thinking', 'reasoning', 'prompt_eng', 'format', 'safety', 'validation'],
}
