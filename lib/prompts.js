...
const INTENT_RECIPE = {
  general:    ['identity', 'execution', 'core', 'reasoning', 'algeria', 'memory', 'format', 'safety', 'validation'],
  news:       ['identity', 'core', 'reasoning', 'algeria', 'search', 'format', 'safety', 'validation'],
  github:     ['identity', 'execution', 'languages', 'core', 'reasoning', 'github_agent', 'format', 'code', 'safety', 'validation', 'recovery'],
  builder:    ['identity', 'execution', 'languages', 'core', 'reasoning', 'format', 'code', 'routing', 'safety', 'validation'],
  structured: ['identity', 'core', 'reasoning', 'algeria', 'search', 'format', 'safety', 'validation'],
  deep:       ['identity', 'execution', 'core', 'reasoning', 'algeria', 'search', 'memory', 'routing', 'format', 'safety', 'validation'],
  thinking:   ['identity', 'core', 'reasoning', 'algeria', 'search', 'validation', 'format', 'safety'],
  code:       ['identity', 'execution', 'languages', 'core', 'reasoning', 'format', 'code', 'routing', 'safety', 'validation'],
