...
export const groqCircuit = new CircuitBreaker('groq')
export const deepseekCircuit = new CircuitBreaker('deepseek')
export const ollamaCircuit = new CircuitBreaker('ollama')
...
export function systemHealthSnapshot() {
  ...
  return {
    ...
    circuits: [
      { name: 'groq', state: groqCircuit.getState() },
      { name: 'deepseek', state: deepseekCircuit.getState() },
      { name: 'ollama', state: ollamaCircuit.getState() },
    ],
