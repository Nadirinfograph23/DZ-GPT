...
const KNOWN_DZ_ENTITIES = {
  ...
  'إبراهيم مازة': { type: 'footballer', hint: 'إبراهيم مازا لاعب كرة قدم جزائري (أستون فيلا)' },
  'مازة': { type: 'footballer', hint: 'إبراهيم مازا لاعب كرة قدم جزائري (أستون فيلا)' },
  'ابراهيم مازا': { type: 'footballer', hint: 'إبراهيم مازا لاعب كرة قدم جزائري (أستون فيلا)' },
  'إبراهيم مازا': { type: 'footballer', hint: 'إبراهيم مازا لاعب كرة قدم جزائري (أستون فيلا)' },
  'مازا': { type: 'footballer', hint: 'إبراهيم مازا لاعب كرة قدم جزائري (أستون فيلا)' },
...
export function cleanSearchQuery(query) {
  return (query || '')
    .replace(/^(?:مع\s+من\s+(?:يلعب|يشتغل|ينشط)|أين\s+يلعب|وين\s+يلعب|فين\s+يلعب|فريق|نادي)\s+/i, '')
