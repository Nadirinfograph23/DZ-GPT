        ...
        if (children.length >= 4) {
          ...
          for (const grp of children) {
            ...
            entries.forEach((e, i) => {
              ...
              const d  = Math.round(getStat('T')  || getStat('ties'))
              const l  = Math.round(getStat('L')  || getStat('losses'))
              const gf = Math.round(getStat('GF') || getStat('pointsFor'))
              const ga = Math.round(getStat('GA') || getStat('pointsAgainst'))
              const pts = Math.round(getStat('PTS') || getStat('points'))
              const gd = gf - ga
