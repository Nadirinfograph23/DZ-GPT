        ...
        if (children.length >= 4) {
          ...
          for (const grp of children) {
            ...
            entries.forEach((e, i) => {
              ...
              const b = isAlg ? '**' : ''
              const ptsStr = isAlg ? `🟢 **${pts}**` : played > 0 && i < 2 ? `**${pts}**` : `${pts}`
              lines.push(`| ${posStr} | ${flag} ${b}${name}${b} | ${played} | ${w} | ${d} | ${l} | ${gf} | ${ga} | ${gdStr} | ${ptsStr} |`)
            })
            lines.push(``)
          }
          lines.push(`---`)
          ...
          lines.push(``)
          lines.push(`🔗 **نتائج حية:** [FIFA](https://www.fifa.com/fifaplus/ar/tournaments/mens/worldcup/canadamexicousa2026) · [ESPN](https://www.espn.com/soccer/standings/_/league/FIFA.WORLD) · [365score](https://www.365scores.com/ar/football/world-cup-2026)`)
