...
const DZ_FACTS = [
  ...
  // ── التاريخ ──────────────────────────────────────────────────────────────
  {
    patterns: [/استقلال الجزائر|تاريخ الاستقلال|independence.*algérie|5.*juillet|5.*يوليو.*1962/i],
  ...
  {
    patterns: [/من هو.*بن بلة|أول.*رئيس.*الجزائر|premier.*président.*algérie/i],
  ...
  // ── الرياضة ──────────────────────────────────────────────────────────────
  {
    ...
    answer: '⚽ شاركت الجزائر في **4 نسخ من كأس العالم**: 1982، 1986، 2010، 2014.\nأفضل نتيجة: **ربع النهائي 2014** في البرازيل.',
  },
  {
    patterns: [/كأس.*أمم.*أفريقيا.*الجزائر|CAN.*الجزائر|algérie.*CAN/i],
    answer: '🏆 فازت الجزائر بـ**كأس أمم أفريقيا** مرتين:\n• **1990** في الجزائر\n• **2019** في مصر',
  },
  {
  ...
  {
    patterns: [/من هو نذير حوامرية|نذير.*infograph|nadir.*houamria|nadir infograph.*من|qui est nadir/i],
...
🌐 **تواصل معه:**
🔵 [فيسبوك](https://www.facebook.com/share/1AM1jDkz8o/) | 📸 [إنستغرام](https://www.instagram.com/nadir.infograph?igsh=ZmJsZGhheXB0emli) | 🎵 [تيكتوك](https://www.tiktok.com/@nadirinfograph2) | ▶️ [يوتيوب](https://www.youtube.com/@Nadirinfograph)`,
  },
  {
    patterns: [/nadir.*tele|نذير.*تلفزيون|nadir.*tv|ظهر.*تلفزيون.*nadir|حصة.*ذكاء اصطناعي.*nadir|nadir.*algerie.*tv/i],
    answer: `📺 **نذير حوامرية في التلفزيون الوطني الجزائري** 🇩🇿

ظهر **نذير حوامرية (Nadir Infograph)** ضيفاً في حصة تقصي مع الدكتورة **عوماري فاطمة الزهراء** حول موضوع **الذكاء الاصطناعي** في التلفزيون الوطني الجزائري.

🎬 [شاهد الحلقة كاملة على يوتيوب](https://youtu.be/-DPOFfvRS-Q?si=TOkP1VFTApMcktJ7)
