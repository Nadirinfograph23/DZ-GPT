          ...
          <div className="dz-home-nav-right">
            ...
            <a
              ...
              style={{
                ...
                boxShadow: '0 0 0 2px #c8860a, 0 2px 8px rgba(200,134,10,0.45)',
                textDecoration: 'none',
                fontSize: 18,
                flexShrink: 0,
                cursor: 'pointer',
              ...
              onMouseLeave={e => {
                ...
                ;(e.currentTarget as HTMLElement).style.boxShadow = '0 0 0 2px #c8860a, 0 2px 8px rgba(200,134,10,0.45)'
              }}
            >
              🇩🇿
            </a>
